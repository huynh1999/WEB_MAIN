...
cd C:\clt\OPUS_FWD_2014\WEB_MAIN
 ...
 "%JAVA_HOME%\bin\java" -cp %classpath%  com.clt.apps.fis.edi.isf.sei.receive.EdiIsfSeiReceive %1 %2 

 "%JAVA_HOME%\bin\java" -cp %classpath%  com.clt.apps.fis.edi.ams.sea.basic.EdiAmsSeaReceive %1 %2 

 "%JAVA_HOME%\bin\java" -cp %classpath%  com.clt.apps.fis.edi.ams.sea.basic.EdiAmsSeaBlockProcess %1 %2 
