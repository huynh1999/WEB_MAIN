<%--
=========================================================
*@FileName   : SEI_FRT_0010.jsp
*@FileTitle  : House B/L Freight
*@Description: 해운수입 HBL Freight
...
<%@ taglib uri="clt-paging"   prefix="paging" %>
    ...
    <script language="javascript" src="<%=CLT_PATH%>/apps/fis/sei/frt/freight/script/SEI_FRT_0010.js?ver=<%=CLT_JS_VER%>"></script>
...
<body class="td" onLoad="loadPage();doWork('SEARCHLIST01');doHideProcess();">
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td nowrap class="table_search_body">          
										<input type="text" name="f_house_bl_no" maxlength="40" value="<bean:write name="rtnMap" property="f_house_bl_no"/>"  class="search_form" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:115px;">
                        ...
                        <td width="770" valign="top">
                            <table width="770" border="0" cellspacing="1" cellpadding="0" class="table">
								<tr>
                                    ...
                                    <td class="grid_head"><bean:message key="HBL_No"/></td>
                                    <td class="table_body_l" colspan="7">
                                ...
                                <tr>
                                    ...
                                    <td class="table_body_l"><wrt:write name="blInfo" property="eta_dt_tm" formatType="DATE" fromFormat="yyyyMMdd" format="yyyy.MM.dd"/>
										<input type="hidden" name="eta_dt_tm" value="<bean:write name="blInfo" property="eta_dt_tm"/>">
									</td>
                    ...
                    <!--B/C Button Layer-->
                                        <table id="bcBtns" border="0" cellspacing="0" cellpadding="0"  <% if(isWritabl){ %>style="display:block;"<% }else{ %>style="display:none;"<% } %>>
                                            <tr>
                                                ...
                                                <td>
                                                    <table onClick="setDfltFrt('b_')"  style="cursor:hand;margin-left:5px;" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td><img src="<%=CLT_PATH%>/web/img/main/tab_bt_left.gif"></td>
                                                            <td background="<%=CLT_PATH%>/web/img/main/tab_bt_bg.gif" class="tab_bt_name_01">Default Freight</td>
                                                            <td><img src="<%=CLT_PATH%>/web/img/main/tab_bt_right.gif"></td>
