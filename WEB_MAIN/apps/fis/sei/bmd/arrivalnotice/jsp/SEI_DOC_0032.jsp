<%--
=========================================================
*@FileName   : SEI_DOC_0032.jsp
*@FileTitle  : DO등록및 수정
*@Description: DO등록및 수정 등록 수정한다.
...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/sei/bmd/arrivalnotice/script/SEI_DOC_0032.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="frm1" method="POST" action="./SEI_DOC_0032.clt" enctype="multipart/form-data">
    ...
    <table width="750" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="bigtitle"><bean:message key="Delivery_Order"/></td>
        </tr>
    </table>
    <table width="750" border="0" cellspacing="0" cellpadding="0">
        <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                     <tr>
                         ...
                         <td class="table_search_body">
                             <input type="text" name="palt_trdp_cd" class="search_form-disable" maxlength="20" value='<bean:write name="objVO" property="palt_trdp_cd"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:80;"/>
