...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/sei/bmd/arrivalnotice/script/SEI_DOC_1081.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="frm1" method="POST" action="./">
	...
	<input type="hidden" name="phn" value="<%=userInfo.getPhn() %>">
				...
				<table>
					...
					<tbody>
						 <tr>
	                         ...
	                         <td>
	                         	<input name="f_hbl_no" type="text" value='<bean:write name="hmOutParam" property="hbl_no"/>' maxlength="40" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px;" class="search_form-disable" readOnly>
	                         </td>
	                     </tr>
	                      <tr>
	                          <th><bean:message key="By"/><!-- M1234 --></th>
	                          <td>
	                          	<input name="f_user_name" type="text" value="<%=userInfo.getUser_name() %>" maxlength="50" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px;" class="search_form-disable" readOnly>
	                          </td>
	                      </tr>
	                     <tr>
	                         <th><bean:message key="Date"/><!-- M1234 --></th>
	                         <td>
	                         	<input name="f_to_date" type="text" value="" maxlength="50" style="width:120px;" class="search_form-disable" readOnly>
	                         </td>
	                     </tr>
	                      <tr>
	                         <th><bean:message key="Send_To"/><!--M1234--></th>
	                          <td nowrap class="table_search_body">
								 <input type="text" name="cfs_trdp_cd" value='<bean:write name="hmOutParam" property="cfs_trdp_cd"/>' class="search_form" style="width:98px;"  onKeyDown="codeNameAction2('trdpcode_send',this, 'onKeyDown')" onBlur="codeNameAction2('trdpcode_send',this, 'onBlur')"><!-- 
							  --><button type="button" class="input_seach_btn" tabindex="-1" onclick="doWork('SEND_POPLIST',this);"></button><!-- 
							  --><input type="text" name="cfs_trdp_nm" value='<bean:write name="hmOutParam" property="cfs_trdp_nm"/>' class="search_form"  style="width:200px;" onKeyPress="if(event.keyCode==13){doWork('SEND_POPLIST', this);}">
	                     ...
	                     <tr>
	                         <th><bean:message key="Release_to"/><!--M1234--></th>
	                          <td nowrap class="table_search_body">
								 <input type="text" name="trdp_cd" value='<bean:write name="hmOutParam" property="trdp_cd"/>' class="search_form" style="width:98px;"  onKeyDown="codeNameAction2('trdpcode_dest',this, 'onKeyDown')" onBlur="codeNameAction2('trdpcode_dest',this, 'onBlur')"><!-- 
							  --><button type="button" class="input_seach_btn" tabindex="-1" onclick="doWork('PARTNER_POPLIST',this);"></button><!-- 
							  --><input type="text" name="trdp_nm" value='<bean:write name="hmOutParam" property="trdp_nm"/>' class="search_form"  style="width:200px;" onKeyPress="if(event.keyCode==13){doWork('PARTNER_POPLIST', this);}">
	                         </td>
	                     </tr>
	                     <tr>
	                         <th><bean:message key="Address"/></th>
	                         <td>
	                             <textarea name="trdp_addr" class="search_form" onblur="strToUpper(this)" style="width:325px;height:80px"><bean:write name="hmOutParam" property="trdp_addr"/></textarea>
	                         </td>
	                     </tr>
	                     <tr>
	                     ...
	                     <tr>
	                        ...
	                        <td>
	                            <textarea name="special_instructions" class="search_form" onblur="strToUpper(this)" style="width:325px;height:80px"></textarea>
	                        </td>
	                    </tr>
	                    <tr>
