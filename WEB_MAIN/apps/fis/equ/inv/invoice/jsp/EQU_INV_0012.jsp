<%--
=========================================================
*@FileName   : EQU_INV_0012.jsp
*@FileTitle  : Agreement Cntr Supply
*@Description: Agreement Cntr Supply 등록 한다.
*@author     : kang daesoo  
...
<script language="javascript" src="./apps/fis/equ/inv/invoice/script/EQU_INV_0012.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="frm1" method="POST" action="./EQU_INV_0012.clt">
	<!--Command를 담는 공통 -->
    <input type="hidden" name="f_cmd" value=""/> 
	<input type="hidden" name="openMean"   value=""/> 
	<input type="hidden" name="inv_no"   value="<%=request.getParameter("inv_no")%>"/> 
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								 <tr>
									 ...
									 <td class="table_search_body">
										 <input type="text" name="eml_to_addr" value='' maxlength="400" class="search_form" style="width:633;"/>
									 </td>
								 </tr>
                                 <tr>
                                     <td width="60" class="table_search_head"><bean:message key="CC"/></td>
                                     <td class="table_search_body">
                                         <input type="text" name="eml_cc_addr" value='' maxlength="400" class="search_form" style="width:633;"/>
                                     </td>
                                 </tr>
                                 <tr>
                                     <td width="60" class="table_search_head"><bean:message key="Title"/></td>
                                     <td class="table_search_body">
                                         <input type="text" name="eml_tit" value='' maxlength="100" class="search_form" style="width:633;"/>
                                     </td>
                                 </tr>
                        ...
                        <td width="100%" rowspan="2" align="left" valign="top">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                 <tr>
                                     ...
                                     <td class="table_search_body">
                                         <textarea name="eml_snd_msg" cols="122" rows="8"></textarea>
