...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<!-- 해당 Action별 js -->
	<script language="javascript" src="./apps/fis/equ/mst/inventory/script/EQU_MST_0051.js?ver=<%=CLT_JS_VER%>"></script>
...
<!-------------------- title begin -------------------->
					<tr>
						<td width="100%" class="bigtitle"><bean:message key="Lease_Term_Code"/></td>
					</tr>
<!-------------------- title end -------------------->
					<!--space -->
			        <tr>
