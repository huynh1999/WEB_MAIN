...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<!-- 해당 Action별 js -->
	<script language="javascript" src="./apps/fis/equ/mst/agreement/script/EQU_POP_0010.js?ver=<%=CLT_JS_VER%>"></script>
...
<!-------------------- title begin -------------------->
					<tr>
						<td width="100%" class="bigtitle"><bean:message key="Cntr_Agreement"/></td>
					</tr>
<!-------------------- title end -------------------->
					<!--space -->
			        <tr>
