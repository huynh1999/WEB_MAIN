...
function doWork(srcName){
    ...
    switch(srcName) {
       ...
       case "SEARCHLIST":
            ...
            //검증로직
            docObjects[0].DoSearch("./ACC_INV_0031GS.clt", FormQueryString(formObj) );
            //조회후  ※ searchEnd로 이동
			 	...
			 	// Duplication check을 Billing information에 있는 Invoice # 와 Vendor Name (CODE)가 있다면 warning message을 보여 줍니다.
			 	  ...
			 	  if (confirm(chrMsgTxt)) {
			 		// 다시한번 널 체크 한다.
	    	          ...
	    	          sheetObj.DoAllSave("./ACC_INV_0031GS.clt", FormQueryString(formObj)+'&'+sht2, true);
			 	  }
               }
    	   }
       break;
    	   ...
    	   if(frm1.f_inv_seq.value != ""){
               ...
               if(confirm(getLabel('FMS_COM_CFMDEL'))){
            	   ...
            	   formObj.f_amt_tot.value=removeComma(formObj.f_amt_tot.value);
	           	   formObj.f_vatamt_tot.value=removeComma(formObj.f_vatamt_tot.value);
	           	   formObj.f_totamt_tot.value=removeComma(formObj.f_totamt_tot.value);
            	   sheetObj.DoSave("ACC_INV_0031GS.clt", FormQueryString(formObj),"ibflag",false);
            	   //화면초기화
            	   clearAll();
               }
        	   // retCnt를 초기화한다.           
       ...
       case "CUSTOMER_NAME"://openMean 1=화면에서 오픈, 2=그리드에서 오픈
        ...
        case 'PRINT':
     	    formObj.file_name.value='invoice_13.mrd';
       		...
       		if(formObj.f_ref_ofc_cd.value == ""){
       			formObj.f_ref_ofc_cd.value = formObj.f_ofc_cd.value;
       		}
...
function loadPage() {
	...
	if (scac_cd == "AVNF"){
		use_flg=true;
		getObj('dept_cd').style.display='block';
	}
//	if(formObj.do_copy.value == "Y"){
//		doWork("COPY");
//	}
 ...
 function authControl(){
	...
	if (blck_ap_inv_add == "N"){
		if (fileBolckYn){
			getObj('addrowBtn2').style.display="none";	
...
//		deleteBtn1.style.display = "inline";
		//span id 처리 getBtnObj('deleteBtn2').style.display="inline";
		getBtnObj('btnDelete').style.display="inline";
//		addrowBtn1.style.display  = "inline";
		getObj('addrowBtn2').style.display="inline";
...
//		deleteBtn1.style.display = "none";
		//span id 처리 getBtnObj('deleteBtn2').style.display="none";
    ...
    switch(sheetNo) {
         case 1:      //IBSheet1 init
            with (sheetObj) {
        	       ...
        	       var headers = [ { Text:getLabel('ACC_INV_0031_HDR_1'), Align:"Center"},
        	                   { Text:getLabel('ACC_INV_0031_HDR_2'), Align:"Center"} ];
        	       ...
        	       var cols = [ {Type:"CheckBox",  Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"del_chk",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:-1, HeaderCheck:0 },
        	              ...
        	              {Type:"Combo",     Hidden:0, Width:400,  Align:"Left",    ColMerge:1,   SaveName:"frt_cd",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
        	              ...
        	              {Type:"Combo",     Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"sls_ofc_cd",        KeyField:1,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
...
//        	              {Type:"Float",      Hidden:1, Width:40,   Align:"Right",   ColMerge:1,   SaveName:"vat_rt",            KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1,   EditLen:5 },
        	              ...
        	              {Type:"Float",      Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"ru",                KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:1,   InsertEdit:1, EditLen:12  },
        	              {Type:"Float",      Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"qty",               KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:1,   InsertEdit:1, EditLen:12  },
...
//        	              {Type:"Float",      Hidden:1, Width:50,   Align:"Right",   ColMerge:1,   SaveName:"inv_xcrt",          KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:4,   UpdateEdit:1,   InsertEdit:1 },
        	              ...
        	              {Type:"Float",     Hidden:0,  Width:120,  Align:"Right",   ColMerge:1,   SaveName:"inv_amt",           KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
...
function resizeSheet() {
	ComResizeSheet(docObjects[0], 85);
}
	...
	if(doc[0]=='OK'){
		if(typeof(doc[1])!='undefined'){
			...
			if(CODETYPE =="VENDOR"){
				...
				if(MULTI_LANGUAGE == 'Y'){
					formObj.f_vendor_nm.value=masterVals[16];	
				}else {
...
function sheet1_OnPopupClick_rat_curr_cd(rtnVal){
	if (rtnVal == "" || rtnVal == "undefined" || rtnVal == undefined) {
		...
		if(docObjects[0].GetCellValue(cur_row,  "rat_curr_cd") == sheetObj.GetCellValue(cur_row, "rat_curr_cd")){
