...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/acc/inv/invoice/script/ACC_INV_0031.js?ver=<%=CLT_JS_VER%>" ></script>
	...
	<div class="opus_design_inquiry">
	    <table>
	    	...
	    	<tr>
              ...
              --><input required type="text" name="f_vendor_nm" maxlength="50" value="" onKeyPress="if(event.keyCode==13){custEnterAction(this,'CUSTOMER_NAME');}" onblur="strToUpper(this);" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:150px" ></td> <!-- #2111 [PATENT] DEPOSIT/PAYMENT ENTRY FOR CN 화면 CUSTOMER 항목 명칭 변경 및 추천 항목 표시 -->
              <td></td>
            ...
            <tr>
              ...
              --><button type="button" id="f_post_dt_cal" onclick="doDisplay('DATE1', frm1);" class="calendar" tabindex="-1"></button></td>
              <td></td>
            ...
            <tr>
              ...
              --><button type="button" id="f_inv_dt_cal" onclick="doDisplay('DATE2', frm1);" class="calendar" tabindex="-1"></button>
	           ...
	           <td><input type="text" name="f_last_paid_dt_cal" style="width:70px" onKeyUp="mkDateFormatType(this, event, false,1)" onBlur="mkDateFormatType(this, event, true,1)" maxlength="10"  readOnly><!--
          ...
          <tr>
              ...
              --><select required name="f_curr_cd" style="width:75px;" onChange="setCurrency();getLoclExRate();"><!--
          ...
          <tr>
			...
			<input type="text" name="f_loc_ex_rate" id="f_loc_ex_rate" maxlength="12" value=""  dataformat="float" style="ime-mode:disabled; text-transform:uppercase;width:75px;text-align:right" class="search_form">
			</td>
		  </tr>
          <tr>
          ...
          <tr>
              ...
              <td style="display:none" <!-- #3181 -->><input type="checkbox" name="f_tax_bill" id="f_tax_bill" value="Y" disabled></td>
          </tr>
          <tr>
			  <th><bean:message key="Office"/></th>
			  <td><!--
			  //#5582 [AIF] Block Date for LAX applied for NYC error
              --><select name="f_ofc_cd" style="width:120px;" onchange="updateBlDt();"/><!--
              --><logic:iterate id="ofcVO" name="oficeList"><!--
          ...
          <tr>
              ...
              <td colspan="3"><textarea name="f_remark" maxlength="500" onkeypress="keyPress_maxLength(this);" onkeyup="keyUp_maxLength(this);" onblur="strToUpper(this);keyUp_maxLength(this);"  dataformat="multiLanguage" style="width:470;height:50px;"></textarea></td>
          </tr>
          </tbody>
	    </table>
	 </div>
