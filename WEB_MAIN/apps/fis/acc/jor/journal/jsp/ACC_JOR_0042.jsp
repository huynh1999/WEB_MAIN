...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0042.js?ver=<%=CLT_JS_VER%>"></script>
	...
	<form name="frm1" id="frm1" method="POST" action="./ACC_JOR_0042.clt">
	<!--Command를 담는 공통 -->
	...
	<input type="hidden" name="pageurl" id="pageurl" value="ACC_JOR_0042.clt"/>
	...
	<div class="page_title_area clear">
				...
				<div class="opus_design_btn TOP"> 
					...
					<button type="button" class="btn_normal" id="btnPrint" onclick="doWork('PRINT')" style="display: none;" btnAuth="<%= roleBtnVO.getAttr5() %>"><bean:message key="Print"/></button> 
					<button type="button" class="btn_normal" style="display:none;"  id="riderprintBtn02" onclick="doWork('RIDERPRINT')"><bean:message key="Rider_Print"/></button> 
			        ...
			        <tbody>
						<tr>
	                        ...
	                        <td><!-- 
					             ...
					             --><input type="text" name="s_vendor_nm" id="s_vendor_nm" maxlength="50" value="" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:136px" onKeyDown="if(event.keyCode == 13){doWork('CUSTOMER_NAME')};" class="search_form">
	                        </td>
			...
			<table>	
			        ...
			        <tbody>
							<tr>
		                        ...
		                        <td>
						            <input onKeyPress="if(event.keyCode==13){doWork('SEARCHLIST');}" type="text" name="s_chk_no" id="s_chk_no" maxlength="20"  value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:219px" class="search_form">
		                        </td>
