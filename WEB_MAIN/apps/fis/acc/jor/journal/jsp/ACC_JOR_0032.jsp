...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0032.js?ver=<%=CLT_JS_VER%>" ></script>
...
<form name="frm1" method="POST" action="./ACC_JOR_0032.clt">
	<!--Command를 담는 공통 -->
	...
	<input type="hidden" name="pageurl" id="pageurl" value="ACC_JOR_0032.clt" />
...
<div class="over_wrap" height="100%">	
	...
	<div class="layout_wrap" style="width: 100%;">
	    <div class="layout_vertical_2" style="width:401px;">
			<div class="opus_design_inquiry entry_pannel" style="height:185px;">
				<table>
					<tr>
						...
						<td align="right">
						 <span class="opus_design_btn">
							<button type="button" btnAuth="<%= roleBtnVO.getAttr1() %>" class="btn_etc" id="rtrvBtn01" onclick="doWork('SEARCHLIST')"><bean:message key="Search"/></button>
						 </span>
						</td>
					</tr>
				</table>
		    	<table>
		    		...
		    		<tbody>
						<tr>
	                        ...
	                        --><input required type="text"  name="s_cust_nm" maxlength="50" value="" onKeyPress="if(event.keyCode==13){custEnterAction(this,'CUSTOMER_NAME');}" onblur="strToUpper(this);" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:165px" ></td> <!-- #2111 [PATENT] DEPOSIT/PAYMENT ENTRY FOR CN 화면 CUSTOMER 항목 명칭 변경 및 추천 항목 표시 -->
	                        <td></td>
						</tr>
						<tr>
							<th><bean:message key="Vendor_Invoice_No"/></th>
	                        <td><!--
	                        --><input type="text" name="s_inv_no" maxlength="50" value="" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:239px" onKeyDown="enterInvoiceNo();"><!--
	    ...
	    <div class="layout_vertical_2" style="padding-left: 8px;width:calc(100% - 410px)">
				<div class="opus_design_inquiry sm" style="height:185px;">
		            ...
		            <table>
		            	<tbody>
							<tr>
								<th style="width: 80px"><bean:message key="Paid_To"/></th>
		                        <td style="width: 150px"><!--
		                        --><input required type="text" name="s_paid_cd" maxlength="20" value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:50px" onKeyDown="codeNameAction('CUSTOMER2',this, 'onKeyDown')" onBlur="codeNameAction('CUSTOMER2',this, 'onBlur')" ><!--
		                        --><button type="button" class="input_seach_btn" tabindex="-1" id="customer" onclick="doWork('CUSTOMER_POPLIST2',this)"></button><!--
		                        --><input required type="text" name="s_paid_nm" maxlength="50" value="" onKeyPress="if(event.keyCode==13){custEnterAction(this,'CUSTOMER2_NAME');}" onblur="strToUpper(this);" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:132px" ></td> <!-- #2111 [PATENT] DEPOSIT/PAYMENT ENTRY FOR CN 화면 CUSTOMER 항목 명칭 변경 및 추천 항목 표시 -->
		                        <th style="width: 100px"><bean:message key="Post_Date"/></th>
		                        ...
		                        <!-- OFVFOUR-8033 [BINEX] Abnormal deposit date input -->
									<% if (!"".equals(jnrNo)) {%>
									    <button id="f_post_dt_cal" type="button" onclick="doDisplay('DATE3', frm1);" class="calendar" tabindex="-1" style="display:none"></button>
									    <%} else if ("Y".equals(userInfo.getPst_dt_flg())){%>
									        <button id="f_post_dt_cal" type="button" onclick="doDisplay('DATE3', frm1);" class="calendar" tabindex="-1" style="display:none"></button>
									        <%}else {%>
									            <button id="f_post_dt_cal" type="button" onclick="doDisplay('DATE3', frm1);" class="calendar" tabindex="-1" style="display:inline"></button>
									            <%}%>
		                        </td>
		                        <th id="trRcvAmt" style="width: 0px; display: none"><bean:message key="Paid_Amount"/></th>
		                        <td id="tdRcvAmt" style="width: 0px; display: none">
		                        	<!-- #3505 [JTC]ACCT - Local Currency 금액 환산 & SLIP 반영  -->
		                        ...
		                        <th style="width: 80px"><bean:message key="Issued_Office"/></th>
		                        <td>
						...
						<table>
							<tbody>
							<tr>
								<th style="width: 80px"><bean:message key="Bank"/></th>
		                        <td style="width: 150px"><!--
		                        --><select name="f_bank_cd" id="f_bank_cd" style="width:215px;" onChange="chageBankCurrCd(this);setBankCurChkNo();" required><!--
		                        ...
		                        --></logic:iterate><!--
		                        --></select></td>
		                        <th style="width: 100px"><bean:message key="Currency"/></th>
		                        <td style="width: 120px"><input type="text" name="f_curr_cd" value="" style="width:40px;text-align:center" class="search_form-disable" readOnly></td>
								<th style="width: 80px"><bean:message key="Check_No"/></th>
		                        <td style="width: 100px"><input type="text" name="f_chk_no" id="f_chk_no" maxlength="20" value="" onblur="strToUpper(this);chkNoChg();" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px" ></td>
                       			<!-- #3505 [JTC]ACCT - Local Currency 금액 환산 & SLIP 반영 -->
		                        <th id="th_ex_rate" style="visibility:hidden;width: 80px"><bean:message key="Local_Ex_Rate"/></th>
		                        <td id="td_ex_rate" style="visibility:hidden;width: 100px"><input type="text" name="f_ex_rate" id="f_ex_rate" maxlength="20" value=""onblur="fnsetLocalAmt();" dataformat="float" style="ime-mode:disabled; text-transform:uppercase;width:80px" class="search_form"></td>
		                        <!-- #3505 [JTC]ACCT - Local Currency 금액 환산 & SLIP 반영 -->
		                        <th id="th_loc_amt" style="visibility:hidden;width: 80px"><bean:message key="Local_Amt"/></th>
		                        <td id="td_loc_amt" style="visibility:hidden;width: 100px"><input type="text" name="f_locl_rcv_amt" id="f_locl_rcv_amt" maxlength="20" value="" dataformat="float" style="ime-mode:disabled; text-transform:uppercase;width:80px" class="search_form" readonly="readonly"></td>
						...
						<table>
							...
							<tr>
		                        ...
		                        --><button type="button" id="f_deposit_dt_cal" onclick="doDisplay('DATE1' ,frm1);" class="calendar" tabindex="-1"></button></td>
		                        ...
		                        <td><input type="text" name="f_void_dt" id="f_void_dt" value=""  maxlength="10" onKeyUp="mkDateFormatType(this, event, false,1);" onBlur="mkDateFormatType(this, event, true,1);dateRangeValid(this, 'Void Date');chkDate(this, frm1.void_chk);checkVoid();" dataformat="excepthan" style="ime-mode:disabled;width:75px;"><!--
		                        --><button type="button" id="f_void_dt_cal" onclick="doDisplay('DATE2' ,frm1);" class="calendar" tabindex="-1"></button></td>
		                        ...
		                        <td><input type="checkbox" name="office_block_chk" id="office_block_chk" onclick="fn_office_block_chk()"><input type="hidden" name="org_office_block_chk" id="org_office_block_chk"></td>			                        
							</tr>
			                <tr>
    ...
    <div class="wrap_result">
    	<div class="opus_design_grid" id="mainTable">
    		<div class="opus_design_btn"><!--
		       --><button id="addBtn02" type="button" class="btn_accent" name="btn_rowAdd" onclick="doWork('ROWADD')"><bean:message key="Add"/></button><!--
		       --><button type="button" class="btn_normal" name="btn_delete" id="invBtn02" onclick="searchInvList('INVADD')" onKeyDown="if(event.keyCode==9){frm1.f_remark.focus();};"><bean:message key="Invoice_Add"/></button>
		    </div>
		...
		<div class="opus_design_inquiry" style="width:100%">
		    	<table>
		    		...
		    		<tbody>
							<tr>
								<td></td>
								<th><bean:message key="Invoice_Amount"/></th>
