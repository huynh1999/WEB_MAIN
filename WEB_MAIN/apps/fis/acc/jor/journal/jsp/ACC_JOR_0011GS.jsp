				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="tax_no"/>]]></TD>                           <!--tax_no            -->
							...
							<TD><![CDATA[<bean:write name="row" property="r_amt" filter="false"/>]]></TD>             <!-- r_amt             -->
							<TD><![CDATA[<bean:write name="row" property="r_curr_cd" />]]></TD>                       <!-- r_curr_cd         -->
							<TD><![CDATA[<bean:write name="row" property="r_rmk" />]]></TD>                           <!-- r_rmk             -->
							<TD><![CDATA[<bean:write name="row" property="sell_buy_tp_cd" />]]></TD>                  <!-- sell_buy_tp_cd    -->
							<TD></TD>                                                                                 <!-- clr_row           -->
							<TD><![CDATA[<bean:write name="row" property="level" />]]></TD>                           <!-- level             -->
							...
							<TD><![CDATA[<bean:write name="row" property="rcvd_fm_nm" />]]></TD>                      <!-- rcvd_fm_nm        -->
							...
							<TD><![CDATA[<bean:write name="row" property="ofc_blck_flg" />]]></TD>                    <!-- ofc_blck_flg      -->
							...
							<TD><![CDATA[<bean:write name="row" property="master_ofc_cd" />]]></TD>                   <!-- master_ofc_cd     -->
							...
							<TD><![CDATA[<bean:write name="row" property="rcvd_fm_cd" />]]></TD>                       <!-- rcvd_fm_cd        -->
						</tr>
					</logic:iterate>
					</DATA>
				</SHEET>
