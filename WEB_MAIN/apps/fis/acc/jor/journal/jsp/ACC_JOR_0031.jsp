...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0031.js?ver=<%=CLT_JS_VER%>" ></script>
...
<form name="frm1" method="POST" action="./ACC_JOR_0031.clt">
	<!--Command를 담는 공통 -->
	...
	<input id="f_usr_ofc_cd" name="f_usr_ofc_cd" value="<%=userInfo.getOfc_cd()%>" type="hidden" />		
	...
	<input type="hidden" name="pageurl" id="pageurl" value="ACC_JOR_0031.clt" />
	...
	<div class="layout_wrap" style="width: 100%;">
	    <div class="layout_vertical_2" style="width: 380px;">
				<div class="opus_design_inquiry entry_pannel" style="height:185px;">
					<table>
						<tr>
							<td id="searchInfo" width="120px"><h3 class="title_design mar_top_4"><bean:message key="Invoice_Search"/></h3></td>
			    	...
			    	<table>
						...
						<tbody>
							<tr>
		                        ...
		                        --><input type="text" name="s_cust_nm" maxlength="50" value="" onKeyPress="if(event.keyCode==13){custEnterAction(this,'CUSTOMER_NAME');}" onblur="strToUpper(this);" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:144px" required></td> <!-- #2111 [PATENT] DEPOSIT/PAYMENT ENTRY FOR CN 화면 CUSTOMER 항목 명칭 변경 및 추천 항목 표시 -->
							</tr>
							<tr>
		                        <th><bean:message key="Vendor_Invoice_No"/></th>
		                        <td><!--
		                        --><input type="text" name="s_inv_no" maxlength="50" value="" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:218px" onKeyDown="enterInvoiceNo();"><!--
		...
		<!-- 2016.04.18 C.W.Park Modified -->
			<div class="layout_vertical_2" style="padding-left:8px;width:calc(100% - 388px)">
		        <div style="width: 100%">
						...
						<table>
							<tbody>
								<tr>
			                        ...
			                        --><input required type="text" name="s_paid_nm" maxlength="50" value="" onKeyPress="if(event.keyCode==13){custEnterAction(this,'CUSTOMER2_NAME');}" onblur="strToUpper(this);" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:130px" ></td> <!-- #2111 [PATENT] DEPOSIT/PAYMENT ENTRY FOR CN 화면 CUSTOMER 항목 명칭 변경 및 추천 항목 표시 -->
						...
						<table>
							<tbody>
								<tr>
			                        ...
			                        <td style="width: 150px"><!--
			                        --><select name="f_bank_cd" id="f_bank_cd" style="width:213px;" onChange="chageBankCurrCd(this);setBankCurChkNo();" required><!--
			                        --><option value=""></option><!--
