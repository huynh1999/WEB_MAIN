...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0030.js?ver=<%=CLT_JS_VER%>" ></script>
...
<form name="frm1" method="POST" action="./ACC_JOR_0030.clt">
	...
	<input type="hidden" name="t_inv_no" 			value="<bean:write name="inv_no"/>"/> <!-- LIST에서 이동시 사용 -->
	...
	<input type="hidden" name="pageurl" id="pageurl" value="ACC_JOR_0030.clt" />
			    	...
			    	<table>
						...
						<tbody>
							<tr>
		                        ...
		                        --><input type="text" name="s_cust_nm" maxlength="50" value="" onKeyPress="if(event.keyCode==13){custEnterAction(this,'CUSTOMER_NAME');}" onblur="strToUpper(this);" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:134px" required></td> <!-- #2111 [PATENT] DEPOSIT/PAYMENT ENTRY FOR CN 화면 CUSTOMER 항목 명칭 변경 및 추천 항목 표시 -->
							</tr>
					...
					<table>
			    		...
			    		<tbody>
			    			<tr>
		                        ...
		                        <td><!--
		                        --><input type="text" name="s_agent_ref_no" maxlength="800" value="" onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:237px">
		                        </td>
							</tr>
			    		</tbody>
					</table>
    ...
    <div class="wrap_result">
    	<div class="opus_design_grid" id="mainTable">
    		 <div class="opus_design_btn"><!--
		       ...
		       --><button type="button" class="btn_normal" id="invBtn02" onclick="searchInvList('INVADD')" onKeyDown="if(event.keyCode==9){frm1.f_remark.focus();};"><bean:message key="Invoice_Add"/></button>
		     </div>
