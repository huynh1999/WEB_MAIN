...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0040.js?ver=<%=CLT_JS_VER%>"></script>
	<%
			...
			<table>	
			        ...
			        <tbody>
						<tr>
								...
								<td><!-- 
									 --><input style="width:75px" type="text" name="s_post_strdt" id="s_post_strdt" maxlength="10" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, this, frm1.s_post_enddt);firCalFlag=false;" size='11' class="search_form" onFocus="select();"><span class="dash">~</span><!-- 
									 --><input style="width:75px" type="text" name="s_post_enddt" id="s_post_enddt" maxlength="10" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, frm1.s_post_strdt, this);firCalFlag=false;" size='11' class="search_form" onFocus="select();"><!-- 
		                        ...
		                        <td><!-- 
						             ...
						             --><input type="text" name="s_vendor_nm" id="s_vendor_nm" maxlength="50" value="" dataformat="multiLanguage" style="ime-mode:disabled; text-transform:uppercase;width:120px" onKeyDown="if(event.keyCode == 13){doWork('CUSTOMER_NAME')};" class="search_form">
		                        </td>
								<th><bean:message key="Office"/></th>
		                        <td>
		                            <bean:define id="oficeList" name="valMap" property="ofcList"/>
		                            <select name="s_ofc_cd" id="s_ofc_cd" style="width:85px;">
			...
			<table>	
			        ...
			        <tbody>
							<tr>
								...
								<td><!-- 
									 --><input style="width:75px" type="text" name="s_deposit_strdt" id="s_deposit_strdt" maxlength="10" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, this, frm1.s_deposit_enddt);firCalFlag=false;" onFocus="select();" size='11' class="search_form"><span class="dash">~</span><!-- 
									 --><input style="width:75px" type="text" name="s_deposit_enddt" id="s_deposit_enddt" maxlength="10" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, frm1.s_deposit_strdt, this);firCalFlag=false;" onFocus="select();" size='11' class="search_form"><!-- 
				...
				<colgroup>
			        ...
			        <tbody>
						<tr>
								...
								<td><!-- 
		                             --><input style="width:75px" type="text" name="s_void_strdt" id="s_void_strdt" maxlength="10" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, this, frm1.s_void_enddt);firCalFlag=false;" onFocus="select();" size='11' class="search_form"><span class="dash">~</span><!-- 
		                             --><input style="width:75px" type="text" name="s_void_enddt" id="s_void_enddt" maxlength="10" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, frm1.s_void_strdt, this);firCalFlag=false;" onFocus="select();" size='11' class="search_form"><!-- 
