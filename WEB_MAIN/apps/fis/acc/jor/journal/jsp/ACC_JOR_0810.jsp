...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/acc/jor/journal/script/ACC_JOR_0810.js?ver=<%=CLT_JS_VER%>"></script>
	<%
	...
	<form name="frm1" method="POST" action="./ACC_JOR_0810.clt">
	<!--Command를 담는 공통 -->
	...
	<input type="hidden" name="pageurl" id="pageurl" value="ACC_JOR_0810.clt"/>
			...
			<table>	
			        ...
			        <tbody>
						<tr>
		                        ...
		                        <td><!-- 
						             --><input type="text" name="s_rcv_from_cd" id="s_rcv_from_cd" maxlength="20" value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:50px" onKeyDown="codeNameAction('BILLTO',this, 'onKeyDown')" onBlur="codeNameAction('BILLTO',this, 'onBlur')" class="search_form"><!-- 
						             --><button type="button" class="input_seach_btn" tabindex="-1" id="billto" onClick="doWork('CUSTOMER_POPLIST')" ></button><!-- 
						             --><input type="text" name="s_rcv_from_nm" id="s_rcv_from_nm" maxlength="50" value="" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:120px" onKeyDown="if(event.keyCode == 13){doWork('CUSTOMER_NAME')};" class="search_form">
		                        </td>
