...
function doWork(srcName){
    ...
    switch(srcName) {
       ...
       case "SEARCHLIST":
            ...
            docObjects[0].DoSearch("./ACC_JOR_0310GS.clt", FormQueryString(formObj) );
       break;
	   case "NEW":
			var paramStr="./ACC_JOR_0210.clt?f_cmd=-1";
		    parent.mkNewFrame('Tax Bill Payment (Korea)', paramStr);
	   break;          
       case "ROWADD":
       ...
       case "MODIFY":	//수정
           ...
           if(confirm(getLabel('FMS_COM_CFMSAV'))){
        	   sheetObj.DoSave("ACC_JOR_0310GS.clt", FormQueryString(formObj),"ibflag",false);
           }
           break;
       case "DELETE":	//삭제
         ...
         case 1:      //IBSheet1 init
            with (sheetObj) {
             ...
             var cols = [ {Type:"Text",      Hidden:0,  Width:35,   Align:"Center",  ColMerge:1,   SaveName:"magam_flag",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:0,   InsertEdit:0 },
                    ...
                    {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"bank_nm",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                    {Type:"Float",     Hidden:0,  Width:90,   Align:"Right",   ColMerge:1,   SaveName:"amt",           KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
...
function sheet1_OnDblClick(sheetObj,Row,Col){
	...
	if(sheetObj.ColSaveName(Col) != "post_dt" && sheetObj.ColSaveName(Col) != "check_flag"){
		var paramStr="./ACC_JOR_0210.clt?f_cmd=-1&s_jnr_no="+sheetObj.GetCellValue(Row, "jnr_no");
	    parent.mkNewFrame('Tax Bill Payment (Korea)', paramStr);
	}
}
