...
//					   if(sheetObj.CellValue(i, "ibflag") == "I"){
       ...
       case "CUSTOMER_POPLIST"://openMean 1=화면에서 오픈, 2=그리드에서 오픈
	   		rtnary=new Array(1);
	   		rtnary[0]="";
//	   		#782 [G&A Deposit Entry] Cannot open empty popup
		...
		case 1:      //IBSheet1 init
			with (sheetObj) {
				...
				var cols = [
        	              ...
        	              {Type:"Float",     Hidden:0,  Width:90,   Align:"Right",   ColMerge:1,   SaveName:"pay_amt",           KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:4,   UpdateEdit:1,   InsertEdit:1, EditLen: 20 },
        	              ...
        	              {Type:"Float",     Hidden:1,  Width:90,   Align:"Right",   ColMerge:1,   SaveName:"locl_amt",          KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1 },
        	              {Type:"Float",     Hidden:1,  Width:90,   Align:"Right",   ColMerge:1,   SaveName:"locl_pay_amt",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1 },
