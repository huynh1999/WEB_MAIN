			...
			<logic:notEmpty name="EventResponse" property="listVal">
				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							<TD><bean:write name="row" property="shp_cmdt_cd"/></TD>
							<TD><bean:write name="row" property="shp_cmdt_nm"/></TD>
							<TD><bean:write name="row" property="pck_ut_cd"/></TD>
							<TD><bean:write name="row" property="pck_ut_nm"/></TD>
							<TD><bean:write name="row" property="pck_qty"/></TD>
							<TD><bean:write name="row" property="rmk"/></TD>
							<TD><bean:write name="row" property="wgt"/></TD>
