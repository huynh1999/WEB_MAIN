...
//			if(checkInpuVals()){
				...
				if(confirm(getLabel('FMS_COM_CFMCRE'))){
					...
					docObjects[0].DoAllSave("./EDI_CSTM_0010GS.clt?" + param, "","",false);
				}
//			}
		break;
		...
		case 2:      //House B/L Information
			with (sheetObj) {
				...
				var cols = [ {Type:"Status",   Hidden:1,  Width:0,     Align:"Left",    ColMerge:1,   SaveName:"ibflag",   			UpdateEdit:0,   InsertEdit:0},
				             {Type:"Text",     Hidden:1,  Width:80,    Align:"Left",    ColMerge:1,   SaveName:"cur_sts",   		UpdateEdit:0,   InsertEdit:0},
				             ...
				             {Type:"Text",     Hidden:0,  Width:70,    Align:"Center",  ColMerge:1,   SaveName:"fwrd_fcty_plc_cd",  UpdateEdit:1,   InsertEdit:1, 	EditLen:8},
				             {Type:"Text",     Hidden:1,  Width:70,    Align:"Left",    ColMerge:1,   SaveName:"gds_clss_cd",  		UpdateEdit:1,   InsertEdit:1, 	EditLen:2},
				             {Type:"Text",     Hidden:1,  Width:110,   Align:"Left",    ColMerge:1,   SaveName:"trkr_trdp_cd",  	UpdateEdit:1,   InsertEdit:1, 	EditLen:6},
				             {Type:"Text",     Hidden:1,  Width:60,    Align:"Left",    ColMerge:1,   SaveName:"rfs_flg",  			UpdateEdit:1,   InsertEdit:1, 	EditLen:3},
				             {Type:"Text",     Hidden:0,  Width:130,   Align:"Left",    ColMerge:1,   SaveName:"ucr_no",   			UpdateEdit:1,   InsertEdit:1, 	EditLen:35},
				             {Type:"Text",     Hidden:1,  Width:90,    Align:"Left",    ColMerge:1,   SaveName:"n1st_spcl_cgo_cd",  UpdateEdit:1,   InsertEdit:1, 	EditLen:4},
				             {Type:"Text",     Hidden:1,  Width:90,    Align:"Left",    ColMerge:1,   SaveName:"n2nd_spcl_cgo_cd",  UpdateEdit:1,   InsertEdit:1, 	EditLen:4},
				             {Type:"Text",     Hidden:1,  Width:80,    Align:"Left",    ColMerge:1,   SaveName:"awb_tp_cd",  		UpdateEdit:1,   InsertEdit:1, 	EditLen:1},
				             {Type:"Text",     Hidden:0,  Width:50,    Align:"Center",  ColMerge:1,   SaveName:"h_expyn",   		UpdateEdit:0,   InsertEdit:0},
