                ...
                <SHEET>
                    ...
                    <logic:iterate id="row" name="rowSet">
                        <tr>
							...
							<TD><![CDATA[<bean:write name="row" property="mbl_vsl_nm"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="hbl_vsl_nm"/>]]></TD>
                            ...
                            <TD><![CDATA[<bean:write name="row" property="no_pck_ut_cd_cnt"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="no_grs_wgt_cnt"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="msn_no"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="no_cntr_no_cnt"/>]]></TD>
                        </tr>
                    </logic:iterate>
                    </DATA>
                </SHEET>
