<%--
=========================================================
*@FileName   : EDI_CSTM_0060.jsp
*@FileTitle  : 해운수입 국내세관 화물적화목록 EDI 처리
*@Description: 해운수입 국내세관 화물적화목록 EDI 처리
...
<%@ page import="java.util.HashMap"%>
    ...
    <script language="javascript" src="<%=CLT_PATH%>/apps/fis/edi/cstm/krcstm/script/EDI_CSTM_0060.js?ver=<%=CLT_JS_VER%>"></script>
	...
	<div class="wrap_result">
		    				...
		    				<tbody>
		                      <tr>
				                ...
				                --><input type="hidden" name="disp_edi_msg_no" style="width:120px" class="search_form-disable" readonly>
		                          ...
		                          <td>
		                              <input type="text"   name="disp_edi_sts" style="width:60px" class="search_form-disable" readonly>
										<input type="hidden" name="cur_edi_sts">
		                          </td>
		                          <th><bean:message key="통지처"/></th>
		                          <td>
		                              <input type="text" name="noti_nm" style="width:70px"  class="search_form-disable"  maxlength="11" readonly>
		                          </td>
		                      </tr>
		                      <tr>
		                          <th><bean:message key="도착일"/></th>
		                      ...
		                      <tr>
				                ...
				                --><input type="text" name="disp_lnr_nm"       style="width:100px" class="search_form-disable" readonly>
		                          ...
		                          <td colspan="3">
		                              <input type="text" name="disp_mrn" style="width:125px"  class="search_form"  maxlength="11" >
		                          </td>
		                     </tr>
						</tbody>
		            </table>
        ...
        <div class="opus_design_grid" id="mainTable" style="width:1280px !important;">
        	<div class="opus_design_btn">
				<span id="btn1" style="display:none;"><button type="button" class="btn_normal" onclick="doWork('COMMAND01')"><bean:message key="전송자료_생성"/></button></span>
