...
<%@ page import="java.util.HashMap"%>
    ...
    <script type="text/javascript" src="<%=CLT_PATH%>/apps/fis/edi/cstm/krcstm/script/EDI_CSTM_0030.js?ver=<%=CLT_JS_VER%>"></script>
    ...
    <script type="text/javascript">
		...
		<logic:notEmpty name="EventResponse" property="mapVal">
	        ...
	        var GDS_CLSS_NM = '';
	        <% isBegin = false; %>
			<logic:notEmpty name="mapObj" property="gdsClssCdList">
				<% isBegin = false; %>
				<bean:define id="gdsClssCdList"  name="mapObj" property="gdsClssCdList"/>
				<logic:iterate id="gdsClssCdVO" name="gdsClssCdList">
					<% if(isBegin){ %>
						GDS_CLSS_CD+= '|';
						GDS_CLSS_NM+= '|';
					<% }else{
					   ...
					   GDS_CLSS_CD+= '<bean:write name="gdsClssCdVO" property="cd_val"/>';
					   GDS_CLSS_NM+= '<bean:write name="gdsClssCdVO" property="cd_nm"/>';
				</logic:iterate>		
			</logic:notEmpty>
	        ...
	        var SPCL_CGO_NM = '';
	        <% isBegin = false; %>
			<logic:notEmpty name="mapObj" property="spclCgoCdList">
				<% isBegin = false; %>
				<bean:define id="spclCgoCdList"  name="mapObj" property="spclCgoCdList"/>
				<logic:iterate id="spclCgoCdVO" name="spclCgoCdList">
					<% if(isBegin){ %>
						SPCL_CGO_CD+= '|';
						SPCL_CGO_NM+= '|';
					<% }else{
					   ...
					   SPCL_CGO_CD+= '<bean:write name="spclCgoCdVO" property="cd_val"/>';
					   SPCL_CGO_NM+= '<bean:write name="spclCgoCdVO" property="cd_nm"/>';
				</logic:iterate>		
			</logic:notEmpty>
		</logic:notEmpty>
	</script>
	...
	<div class="wrap_result">
				        ...
				        <tbody>
							<tr>
		                       ...
		                       <tr>
		                           ...
		                           <td>
		                           	<input type="text" name="disp_decnsl_cmp_cd" id="disp_decnsl_cmp_cd" style="width:120px" class="search_form-disable" maxlength="4" value="" readonly>
		                         	</td>
		...
		<div class="opus_design_grid" id="mainTable" style="width:1280px !important;">
			<div class="opus_design_btn">
				<button id="btn1"  class="btn_normal" type="button"  style="display:none;"  onclick="doWork('COMMAND01')"><bean:message key="전송자료_생성"/></button>
