        ...
        switch(srcName) {
    	   case "SEARCHLIST":
                ...
                if(validateForm(sheetObj, formObj, SEARCHLIST, 1)){
                	sheetObj.DoSearch("./EDI_AWB_0020GS.clt", FormQueryString(formObj) );
                    //디버깅
...
function loadPage() {
	...
	//formObj.f_bl_no.value=arg[0];
	formObj.f_intg_bl_seq.value=arg[0];
	formObj.f_msg_tp_cd.value=arg[1];
    ...
    switch(sheetNo) {
         case 1:      //IBSheet1 init
            with (sheetObj) {
	          ...
	          //MSG_KEY['EDI_AWB_0020_HDR'] = "Seq|Send Date|Receive Date|EDI Type|EDI Action|EDI Status |Message";
	          
	          var info    = { Sort:1, ColMove:1, HeaderCheck:1, ColResize:1 };
	          var headers = [ { Text:getLabel('EDI_AWB_0020_HDR'), Align:"Center"} ];
		...
		//	              {Type:"Text",      Hidden:0,  Width:80,   Align:"Left",    ColMerge:0,   SaveName:"smt_tp_cd",  		KeyField:0,   CalcLogic:"",   Format:"" },
			              {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"msg_sts_nm",  		KeyField:0,   CalcLogic:"",   Format:"" },
			              {Type:"Text",      Hidden:0,  Width:500,  Align:"Left",    ColMerge:0,   SaveName:"err_msg",  		KeyField:0,   CalcLogic:"",   Format:"" },
