...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/edi/aci/script/EDI_ACI_0014.js?ver=<%=CLT_JS_VER%>"></script>
	<!--ajax 사용시 -->
...
<form name="frm1" method="POST" action="./">
	...
	<input	type="hidden" name="f_mbl_no" value="<bean:write name="valMap" property="f_mbl_no"/>"/> 
					...
					<tbody>
						...
						<tr height="25px">
							 <th><bean:message key="Action_Type"/></th>
			              	<td>
								<select name="f_smt_tp_cd" class="search_form" style="width:120px;text-align:left" onChange = "chgSmtTp()">
							       	<option value="">Auto</option>
							       	<option value="Original">Original</option>
							       	<option value="Correct">Correct</option>
							       	<option value="Delete">Delete</option>
							       	<option value="Amendment">Correct After Vessel Arrival</option>
								</select>
			                </td>
