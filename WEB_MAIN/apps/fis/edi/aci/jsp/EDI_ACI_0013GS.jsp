                ...
                <SHEET>
                    ...
                    <logic:iterate id="row" name="rowSet">
                        <tr>
                            ...
                            <TD><![CDATA[<bean:write name="row" property="clz_smt_tp_cd"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="clz_msg_sts_cd"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="clz_msg_sts_nm"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="clz_err_msg"/>]]></TD>
                            <TD></TD>
                            <TD></TD>
                        </tr>
                    </logic:iterate>
