		...
		switch(srcName) {
			...
			break;
          	...
          	break;
	   	    ...
	   	    break;
	   	    case "CUSTOMER_POPLIST2_CLS"://openMean 1=화면에서 오픈, 2=그리드에서 오픈
	   	    	if(curObj.value == ""){
		   			formObj.txt_to_nm.value = "";
		   			formObj.txt_to_addr.value = "";
		   		};	   	        
	   	    break;
	   	    ...
	   	    break;
	   	    case "CUSTOMER_POPLIST3_CLS"://openMean 1=화면에서 오픈, 2=그리드에서 오픈
	   	    	if(curObj.value == ""){
	   	    		formObj.txt_glt_nm.value = "";
	   	    		formObj.txt_glt_addr.value = "";
	   	    	}	   	    		
...
function loadPage() {
	...
	//setTimeout("document.frm1.txt_hbl_no.focus();",1000);
}
/**
달력팝업을 호출한다.
**/
