...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/aie/bmd/housebl/script/AIE_BMD_0210.js?ver=<%=CLT_JS_VER%>" ></script>
...
<form name="frm1" method="POST" action="./AIE_BMD_0210.clt">
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><!-- 
						 --><input type="text" id="txt_hbl_no" name="txt_hbl_no" required="true" maxlength="40" value='' class="search_form" dataformat="excepthan" style="ime-mode:disabled;width:130;text-transform:uppercase;" onblur="strToUpper(this);selectBlInfo();" onkeydown="isBlNoEdit();"/><!-- 
	   			...
	   			<table>
					...
					<tbody>
	                    ...
	                    <tr>
				             ...
				             <input id="cnt_nm" name="cnt_nm" type="hidden">
				             </td>
	                    </tr>
	                    <tr>
	   			...
	   			<table>
					...
					<tbody>
	                     ...
	                     <tr>
	                         ...
	                         <td><input type="text" id="f_vslflt" value='' onblur="strToUpper(this)"  class="search_form db_data" dataformat="excepthan" style="ime-mode:disabled;width:70px;text-transform:uppercase;" maxlength="20" columnName="vsl_flt"></td>
	                    </tr>
	                    <tr>
