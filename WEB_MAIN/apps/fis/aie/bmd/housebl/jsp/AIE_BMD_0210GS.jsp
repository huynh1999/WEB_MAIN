				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="pck_dt"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="item_ru"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="oth_itm_seq"/>]]></TD>
							<!-- #2827 : [BINEX]Fresh Cargo C/I & P/L 기능 수정 -->
							<TD><![CDATA[<bean:write name="row" property="attr_nm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="dtlcd_v"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="dtlcd_l"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="dtlcd_p"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="dtlcd_s"/>]]></TD>
			            </tr>
					</logic:iterate>
					</DATA>
				</SHEET>
