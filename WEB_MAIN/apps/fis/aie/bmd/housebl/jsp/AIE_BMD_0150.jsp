...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/aie/bmd/housebl/script/AIE_BMD_0150.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="frm1" method="POST" action="./AIE_BMD_0150.clt">
	<!--Command를 담는 공통 -->
	<input type="hidden" name="f_cmd"/>
	<input type="hidden" name="f_CurPage"/>
	<input type="hidden" name="trdp_cd"/>
	<input type="hidden" name="f_intg_bl_seq" value='<bean:write name="coVO" property="intg_bl_seq"/>' />
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><!-- 
						 --><input required type="text" name="txt_hbl_no"  maxlength="40" value='<bean:write name="coVO" property="txt_hbl_no"/>' dataformat="excepthan" style="ime-mode:disabled;width:110;text-transform:uppercase;" onblur="strToUpper(this)"><!-- 
						 ...
						 --><input type="hidden" name="hbl_no" value='<bean:write name="coVO" property="txt_hbl_no"/>'></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div class="layout_wrap">
	   			...
	   			<table>
					...
					<tbody>
                       <tr>
                           ...
                           <td><input type="text" name="f_bl_no" maxlength="40" value='<bean:write name="coVO" property="bl_no"/>' onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px"></td>
                       </tr>
                       <tr>
                        ...
                        <tr>
	                         ...
	                         <td><input type="text" name="f_point_entry" maxlength="50" value='<bean:write name="coVO" property="point_entry"/>' onblur="strToUpper(this);" dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px"></td>
	                     </tr>
                        <tr>
                            <th><bean:message key="Export_Carrier"/></th>
                            <td><input type="text" name="f_exp_carrier" maxlength="350" value='<bean:write name="coVO" property="exp_carrier"/>' dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:300px"></td>
                        </tr>
                        <tr>
	   	...
	   	<table class="grid2">
			...
			<tbody>
	    		...
	    		<tr>
	    			<!-- #924 [8][AEH Certificate of Origin] -->
	    			<td><textarea name="f_mark_num" maxlength="4000" onkeypress="keyPress_maxLength2(this,4000);" onkeyup="fn_ComGetLenByByte(this,4000);" dataformat="excepthan" style="width:100%;height:250px;"><bean:write name="coVO" property="mk_txt"/></textarea></td>
	    			<td><textarea name="f_qty" maxlength="500" onkeypress="keyPress_maxLength2(this,500);" onkeyup="fn_ComGetLenByByte(this,500);" dataformat="excepthan" style="width:100%;height:250px;text-align:right"><bean:write name="coVO" property="qty"/></textarea></td>
	    			<td><textarea name="f_desc_good" maxlength="4000" onkeypress="keyPress_maxLength2(this,4000);" onkeyup="fn_ComGetLenByByte(this,4000);"  dataformat="excepthan" style="width:100%;height:250px;"><bean:write name="coVO" property="desc_txt"/></textarea></td>
	    			<td><textarea name="f_grs_wgt" maxlength="500" onkeypress="keyPress_maxLength2(this,500);" onkeyup="fn_ComGetLenByByte(this,500);"  dataformat="excepthan" style="width:100%;height:250px;text-align:right;"><bean:write name="coVO" property="grs_wgt"/></textarea></td>
	    			<td><textarea name="f_chg_wgt" maxlength="500" onkeypress="keyPress_maxLength2(this,500);" onkeyup="fn_ComGetLenByByte(this,500);"  dataformat="excepthan" style="width:100%;height:250px;text-align:right;"><bean:write name="coVO" property="chg_wgt"/></textarea></td>
	    			<td><textarea name="f_meas" maxlength="500" onkeypress="keyPress_maxLength2(this,500);" onkeyup="fn_ComGetLenByByte(this,500);"  dataformat="excepthan" style="width:100%;height:250px;text-align:right;"><bean:write name="coVO" property="meas"/></textarea></td>
	    		</tr>
	    	</tbody>
   		</table>
	</div>	
