...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/aie/bmd/housebl/script/AIE_BMD_0130.js?ver=<%=CLT_JS_VER%>" ></script>
	   	...
	   	<table class="grid2">
			...
			<tbody>
   			<tr>
    			...
    			<th><bean:message key="QTY"/>/<bean:message key="UOM"/></th>
    			<th><bean:message key="Description_of_Packages_and_Goods"/></th>
    			<th><bean:message key="Unit_Price"/></th>
    			<th><bean:message key="Amount"/></th>
    		</tr>
       		<tr>
       			<td height="250px"><textarea name="f_mark_num" maxlength="4000" onkeypress="keyPress_maxLength(this);" onkeyup="keyUp_maxLength(this);" onblur="strToUpper(this);keyUp_maxLength(this);" class="search_form" dataformat="excepthan" style="width:100%;height:250px;"><bean:write name="plVO" property="mk_txt"/></textarea></td>
       			...
       			<td><textarea name="f_desc_good" id="f_desc_good" maxlength="4000" onkeypress="keyPress_maxLength(this);" onkeyup="keyUp_maxLength(this);" onblur="strToUpper(this);keyUp_maxLength(this);" class="search_form" dataformat="excepthan" style="width:100%;height:250px;"><bean:write name="plVO" property="desc_txt"/></textarea></td>
