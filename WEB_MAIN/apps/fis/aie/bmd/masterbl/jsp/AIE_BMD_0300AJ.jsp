...
=========================================================
=========================================================
*@FileName   : AIE_BMD_0300AJ.jsp
*@FileTitle  : Air Quotation
*@Description: 
...
<logic:empty name="com.clt.framework.core.comm.EXCEPTION_OBJECT      ">
	<logic:notEmpty name="EventResponse" property="objVal">
		...
		<DATA>
			...
			<vty_dt><![CDATA[<wrt:write name="qttnVo" property="vty_dt" formatType="DATE" fromFormat="yyyyMMdd" format="MM-dd-yyyy" filter="false" />]]></vty_dt>
			...
			<chg_wgt_kg><![CDATA[<bean:write name="qttnVo" property="chg_wgt_kg"  filter="false" />]]></chg_wgt_kg>
			<chg_wgt_lbs><![CDATA[<bean:write name="qttnVo" property="chg_wgt_lbs" filter="false" />]]></chg_wgt_lbs>
			...
			<rate_qttn_txt><![CDATA[<bean:write name="qttnVo" property="rate_qttn_txt" filter="false" />]]></rate_qttn_txt>
			...
			<size_ut_cd><![CDATA[<bean:write name="qttnVo" property="size_ut_cd" filter="false" />]]></size_ut_cd>
		</DATA>
	</logic:notEmpty>    
</logic:empty>
