...
<script type="text/javascript" src="<%=CLT_PATH%>/apps/fis/aie/bmd/masterbl/script/AIE_BMD_0300.js?ver=<%=CLT_JS_VER%>"></script>
...
<script>	
 ...
 <script type="text/javascript">
	...
	// [#1188][AI Quotation Entry] Cannot auto suggestion when name inputted
 ...
 <form name="frm1">
	...
	<input type="hidden" name="bnd_clss_cd"  value="<bean:write name="valMap" property="bnd_clss_cd"/>">
						...
						<tbody>
							...
							<tr>
	                            ...
	                            <td colspan="3">
	                            	...
	                            	--><button type="button" id="cust" name="cust" class="input_seach_btn" tabindex="-1" onClick="doWork('CUST_POPLIST')"></button><!--
	                             	--><input type="text" name="cust_nm" id="cust_nm" maxlength="200" value='<bean:write name="qttnVo" property="cust_nm"/>' class="search_form" style="ime-mode:disabled;text-transform:uppercase;width:238px;" onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){doWork('CUST_POPLIST_NAME');}">
	                      		</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3">
									...
									--><input type="text" name="agn_nm" id="agn_nm" maxlength="200" value='<bean:write name="qttnVo" property="agn_nm"/>' onblur="strToUpper(this)" class="search_form" style="ime-mode:disabled;text-transform:uppercase;width:238px;" onKeyPress="if(event.keyCode==13){doWork('AGN_POPLIST_NAME');}">
								</td>
				            </tr>
				            <tr>
								...
								<td>
									<input type="text" name="vty_dt" id="vty_dt" maxlength="20" value="<wrt:write name="qttnVo" property="vty_dt" formatType="DATE" fromFormat="yyyyMMdd" format="MM-dd-yyyy"/>" class="search_form" style="ime-mode:disabled;text-transform:uppercase;width:101px;" onKeyUp="mkDateFormatType(this, event, false,1)" onBlur="mkDateFormatType(this, event, true,1);strToUpper(this);">
	                       	...
	                       	<tr>
								...
								<td colspan="3">
									...
									--><input type="text" name="cmdt_nm" id="cmdt_nm" maxlength="300" value="<bean:write name="qttnVo" property="cmdt_nm"/>" class="search_form" onBlur="strToUpper(this);" onchange="" onKeyPress="if(event.keyCode==13){doWork('COMMODITY_POPLIST_NAME');}" style="ime-mode:disabled; text-transform:uppercase;width:238px;">
								</td>
							</tr>
							<tr>
								<th><bean:message key="Package"/></th>
								<td colspan="3">
									<input type="text" name="pck_qty" id="pck_qty" value="<bean:write name="qttnVo" property="pck_qty"/>" onkeyPress="onlyNumberCheck();" onkeyup="pkgChange(this);numberCommaLen(this,8,0)" maxlength="7"  class="search_form zero_remove" style="ime-mode:disabled;width:60px;text-align:right"><!--
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" name="grs_wgt_kg" id="grs_wgt_kg" value="<bean:write name="qttnVo" property="grs_wgt_kg"/>" onkeyPress="onlyNumberCheck('.');" onchange="weightChange(this);numberCommaLen(this,9,2);chkComma(this,9,2);" maxlength="13" class="search_form zero_remove" style="ime-mode:disabled;width:60px;text-align:right;"><!--
									--><input type="text" name="grs_wgt_kg_ut_cd" id="grs_wgt_kg_ut_cd" value="KG" style="width:86px;border:0;background-color:transparent;" tabindex="-1" readOnly><!--
									--><input type="text" name="grs_wgt_lbs" id="grs_wgt_lbs" value="<bean:write name="qttnVo" property="grs_wgt_lbs"/>" onkeyPress="onlyNumberCheck('.');" onchange="weightChange(this);numberCommaLen(this,9,2);chkComma(this,9,2);" maxlength="13" class="search_form zero_remove" style="ime-mode:disabled;width:60px;text-align:right;"><!--
									--><input type="text" name="grs_wgt_lbs_ut_cd" id="grs_wgt_lbs_ut_cd" value="LB" style="width:86px;border:0;background-color:transparent;" tabindex="-1" readOnly>
								</td>
							</tr>
							<tr>
								<th><bean:message key="Chargeable_Weight"/></th>
								<td colspan="3">
									<input type="text" name="chg_wgt_kg" id="chg_wgt_kg" value="<bean:write name="qttnVo" property="chg_wgt_kg"/>" onkeyPress="onlyNumberCheck('.');" onchange="weightChange(this);numberCommaLen(this,9,2);chkComma(this,9,2);" maxlength="13" class="search_form zero_remove" style="ime-mode:disabled;width:60px;text-align:right;"><!--
									--><input type="text" name="chg_wgt_kg_ut_cd" id="chg_wgt_kg_ut_cd" value="KG" style="width:86px;border:0;background-color:transparent;" tabindex="-1" readOnly><!--
									--><input type="text" name="chg_wgt_lbs" id="chg_wgt_lbs" value="<bean:write name="qttnVo" property="chg_wgt_lbs"/>" onkeyPress="onlyNumberCheck('.');" onchange="weightChange(this);numberCommaLen(this,9,2);chkComma(this,9,2);" maxlength="13" class="search_form zero_remove" style="ime-mode:disabled;width:60px;text-align:right;"><!--
									--><input type="text" name="chg_wgt_lbs_ut_cd" id="chg_wgt_lbs_ut_cd" value="LB" style="width:86px;border:0;background-color:transparent;" tabindex="-1" readOnly>
							</tr>
							<tr>
								<th><bean:message key="Measurement"/></th>
								<td colspan="3"><input type="text" name="meas_cbm" id="meas_cbm" value="<bean:write name="qttnVo" property="meas_cbm"/>" onkeyPress="onlyNumberCheck('.');" onchange="cbmChange(this);numberCommaLen(this,8,3);chkComma(this,8,3);" maxlength="13" class="search_form zero_remove" style="ime-mode:disabled;width:60px;text-align:right;"><!--
									...
									--><input type="text" name="meas_cft" id="meas_cft" value="<bean:write name="qttnVo" property="meas_cft"/>" onkeyPress="onlyNumberCheck('.');" onchange="cbmChange(this);numberCommaLen(this,9,3);chkComma(this,8,3);" maxlength="13" class="search_form zero_remove" style="ime-mode:disabled;width:60px;text-align:right;"><!--
						...
						<tbody>
							<tr>
                                ...
                                <td colspan="3"><input type="text" name="por_cd" id="por_cd" maxlength="5" value='<bean:write name="qttnVo" property="por_cd"/>' class="search_form" onKeyDown="codeNameAction('POR',this, 'onKeyDown','A')" onBlur="strToUpper(this);codeNameAction('POR',this, 'onBlur','A')" style="ime-mode:disabled; text-transform:uppercase;width:60px;"><!--
                                	...
                                	--><input type="text" name="por_nm" id="por_nm" maxlength="50" value='<bean:write name="qttnVo" property="por_nm"/>' class="search_form" style="ime-mode:disabled;width:238px;text-transform:uppercase;" onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){locOpenPopUpName(document.getElementById('por'), 'A');}">
								</td>
							</tr>
							<tr>
								...
								<td colspan="3"><input type="text" name="pol_cd" id="pol_cd" maxlength="5" value='<bean:write name="qttnVo" property="pol_cd"/>' class="search_form" onKeyDown="codeNameAction('POL',this, 'onKeyDown','A')" onBlur="strToUpper(this);codeNameAction('POL',this, 'onBlur','A')" style="ime-mode:disabled; text-transform:uppercase;width:60px;"><!--
									...
									--><input type="text" name="pol_nm" id="pol_nm" maxlength="50"  value='<bean:write name="qttnVo" property="pol_nm"/>' class="search_form" style="ime-mode:disabled; text-transform:uppercase;width:238px;text-transform:uppercase;" onblur="strToUpper(this);" onKeyPress="if(event.keyCode==13){locOpenPopUpName(document.getElementById('pol'), 'A');}">
								</td>
							</tr>
							<tr>
								...
								<td colspan="3"><input type="text" name="pod_cd" id="pod_cd" maxlength="5" value='<bean:write name="qttnVo" property="pod_cd"/>' class="search_form" onKeyDown="codeNameAction('POD',this, 'onKeyDown','A')" onBlur="strToUpper(this);codeNameAction('POD',this, 'onBlur','A')" style="ime-mode:disabled; text-transform:uppercase;width:60px;"><!--
									...
									--><input type="text" name="pod_nm" id="pod_nm" maxlength="50"  value='<bean:write name="qttnVo" property="pod_nm"/>' class="search_form" style="ime-mode:disabled; text-transform:uppercase;width:238px;text-transform:uppercase;" onblur="strToUpper(this);" onKeyPress="if(event.keyCode==13){locOpenPopUpName(document.getElementById('pod'), 'A');}">
								</td>
							</tr>
							<tr>
								...
								<td colspan="3"><input type="text" name="del_cd" id="del_cd" maxlength="5" value='<bean:write name="qttnVo" property="del_cd"/>' class="search_form" onKeyDown="codeNameAction('DEL',this, 'onKeyDown','A')" onBlur="strToUpper(this);codeNameAction('DEL',this, 'onBlur','A')" style="ime-mode:disabled; text-transform:uppercase;width:60px;"><!--
									...
									--><input type="text" name="del_nm" id="del_nm" maxlength="50" value='<bean:write name="qttnVo" property="del_nm"/>' class="search_form" style="ime-mode:disabled;width:238px;text-transform:uppercase;" onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){locOpenPopUpName(document.getElementById('del'), 'A');}">
								</td>
							</tr>
							<tr>
								...
								<td colspan="3"><input type="text" name="fnl_dest_loc_cd" id="fnl_dest_loc_cd" maxlength="5" value='<bean:write name="qttnVo" property="fnl_dest_loc_cd"/>' class="search_form" onKeyDown="codeNameAction('DEST',this, 'onKeyDown','A')" onBlur="strToUpper(this);codeNameAction('DEST',this, 'onBlur','A')" style="ime-mode:disabled; text-transform:uppercase;width:60px;"><!--
									...
									--><input type="text" name="fnl_dest_loc_nm" id="fnl_dest_loc_nm" maxlength="50" value='<bean:write name="qttnVo" property="fnl_dest_loc_nm"/>' class="search_form" style="ime-mode:disabled;width:238px;text-transform:uppercase;" onblur="strToUpper(this)" onKeyPress="if(event.keyCode==13){locOpenPopUpName(document.getElementById('dest'), 'A');}">
								</td>
							</tr>
							<tr>
		...
		<div id="FREE_FORM_Y" style="display: none">
			<div class="opus_design_inquiry sm" style="height: 323px;">
				<table>
					<tr>
			       		<td>
			           		<textarea name="free_form_txt" id="free_form_txt" cols="200" rows="22" maxlength="4000" onkeypress="keyPress_maxLength(this);" onkeyup="keyUp_maxLength(this);" onblur="strToUpper(this);keyUp_maxLength(this);" style="width: 970px">
