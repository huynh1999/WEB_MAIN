<%--
=========================================================
*@FileName   : AII_FRT_0020.jsp
*@FileTitle  : MAWB Freight
*@Description: 항공수입 MBL Freight
*@author     : Kang,Jung-Gu
*@version    : 
*@since      : 
...
<%@ taglib uri="clt-paging"   prefix="paging" %>
    ...
    <script language="javascript" src="<%=CLT_PATH%>/apps/fis/aii/frt/freight/script/AII_FRT_0020.js?ver=<%=CLT_JS_VER%>"></script>
	<script>
		var STATUSCD1 = '';
		var STATUSCD2 = '';
...
<body class="td" onLoad="javascript:loadPage();doWork('SEARCHLIST02');">
