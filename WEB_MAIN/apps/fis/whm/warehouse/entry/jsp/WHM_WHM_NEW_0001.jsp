...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/whm/warehouse/entry/script/WHM_WHM_NEW_0001.js?ver=<%=CLT_JS_VER%>"></script>
...
<div class="over_wrap">	
	...
	<div class="wrap_result">
		<div class="opus_design_inquiry">
			<h3 class="title_design"><bean:message key = "Warehouse_Information" /></h3>
			<table style="width:500px;">
				...
				<tbody>
					<tr>
			        	<th><bean:message key="Code"/></th>
			           	<td>
			           		<input type="text" name=TxtCreCode id="TxtCreCode" value="" style="width:200px;text-transform:uppercase;" onBlur="strToUpper(this);" class="search" required maxlength = "8" onchange="validCode(this)" onKeyPress="ComKeyOnlyAlphabet('uppernum')" onblur="checkDupInsertWhCode()">
			 			</td>
		 			</tr>
			        <tr>
			 		...
			 		<tr>
						...
						<td style="width:130px">
							<bean:define id="ofcList"  name="mapVal" property="ofcList"/>
			            	<select name="wh_ofc_cd" class="search_form" style="width:102;" required>
			 		...
			 		<tr>
			 			<th valign = "top"><bean:message key = "Address" /></th>
			           	<td colspan="3">
			           		<textarea id="TxtAddress" name="TxtAddress" rows="5" maxlength="400" cols="100" wrap="off" style="width:100%;;text-transform:uppercase;" onblur="onBlurTextCounter(this, 400);strToUpper(this);"></textarea>
			 			</td>
			 			<td></td>
			 			<td></td>
			 		</tr>
			 		<tr>
			 			<th><bean:message key = "City" /></th>
			           	<td colspan="3">
			           		<input type="text" name=TxtCity id="TxtCity" value="" maxlength="20" style="width:100%;text-transform:uppercase;" onBlur="strToUpper(this);" class="search_form">
			 			</td>
			 			<td></td>
			 			<td></td>
			   		</tr>
			   		<tr>
			 			<th><bean:message key = "State" /></th>
			           	<td>
			           		<input type="text" name=TxtState id="TxtState" value="" style="width:100px;text-transform:uppercase;" onBlur="strToUpper(this);" class="search_form" maxlength=2 disabled onKeyPress="ComKeyOnlyAlphabet()"><!--
			   		...
			   		<tr>
			 			<th><bean:message key = "Phone" /></th>
			           	<td colspan="3">
			           		...
			           		<input type="text" name=TxtPhone id="TxtPhone" value="" maxlength="20"  dataformat="excepthan" style="ime-mode:disabled;width:100%;text-transform:uppercase;" onBlur="strToUpper(this);" class="search_form">
			 			</td>
			 			<td></td>
			 			<td></td>
			   		</tr>
			   		<tr>
			 			<th><bean:message key = "Fax" /></th>
			           	<td colspan="3">
			           		<input type="text" name=TxtFax id="TxtFax" value=""   dataformat="excepthan" style="ime-mode:disabled;width:100%;text-transform:uppercase;" onBlur="strToUpper(this);" maxlength="20" align="right"  class="search_form">
			 			</td>
			 			<td></td>
			 			<td></td>
			 		</tr>
			   		<tr>
			 			<th valign = "top"><bean:message key = "Remark" /></th>
			           	<td colspan="3">
			           		<textarea id="TxtRemark" name="TxtRemark" rows="5" cols="100" wrap="off" maxlength="400" style="width:100%;;text-transform:uppercase;" onBlur="strToUpper(this);" onblur="onBlurTextCounter(this, 400)"></textarea>
			 			</td>
			 			<td></td>
			 			<td></td>
			 		</tr>
    	...
    	<%-- <div class="opus_design_inquiry">
			<h3 class="title_design"><bean:message key = "Warehouse_Storage_Charge_Option" /></h3>
			<table style="width:500px;">
				<colgroup>
					<col width="50px">
					<col width="150px">
				...
				<tbody>
			        <tr>
						<th>&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key = "Include_Outbound_Date" /></th>
			           	<td colspan="3" >
			           		<select name="incl_ob_dt_flg" id="incl_ob_dt_flg" class="search_form" style="width:50px;" required>
                                <option value=""></option>
                                <option value="Y">Y</option><!-- 출고일 Storage Charge 포함 : 기존 로직 -->
                                <option value="N">N</option><!-- 출고일 Storage Charge 미포함 : 신규 요구사항(LOA) -->
                            </select>
			 			</td>
			 			<th></th>
			 			<td></td>
