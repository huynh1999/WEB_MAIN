...
<script language="javascript" src="./apps/fis/whm/inventory/script/WHM_WHM_0015.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="frm1" method="post" action="./WHM_WHM_0015.clt" style="margin:0px">
	<input type="hidden" name="f_cmd" id="f_cmd"/>
	<input type="hidden" name="f_save_sts_flg" id="f_save_sts_flg"/>
	<input type="hidden" name="f_CurPage" id="f_CurPage"/>
	<input type="hidden" name="pageurl" id="pageurl" value="WHM_WHM_0015.clt"/>
...
<%--				<tbody>
				...
				<tr>
           		 ...
           		 --><input type="text" name="cust_nm" id="cust_nm" value="" style="width:270px;" class="search" onKeyDown="if(event.keyCode==13){doWork('WH_POPLIST_NAME');}">
					</td>
				</tr>
				<tr>
					<th><bean:message key="Period"/></th>
					<td><input required style="width: 77px;" type="text" id="etd_strdt" name="etd_strdt" onkeyup="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onblur="chkCmprPrd(firCalFlag, false, this, this, form.etd_enddt);firCalFlag=false;" size="11" maxlength="10"><!--
					 --><span class="dash">~</span><!--
					 --><input required style="width: 77px;" type="text" id="etd_enddt" name="etd_enddt" onkeyup="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onblur="chkCmprPrd(firCalFlag, false, this, form.etd_strdt, this);firCalFlag=false;" size="11" maxlength="10"><!--
					...
					<td nowrap>
						<div id="div_subcode">
							...
							<select name="f_ofc_cd" id="f_ofc_cd" style="width:90px">
