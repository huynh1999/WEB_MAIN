        ...
        switch(srcName) {
    	   case "SEARCHLIST":
    		  // if(!formValidation()) return;
    		   ...
    		   sheetObj.DoSearch("WHM_POP_0007GS.clt", FormQueryString(formObj) );
    	   ...
    	   case "APPLY":
    		   ...
    		   for(var i=2 ; i < sheetObj.LastRow() + 1 ; i++){
    			   if(sheetObj.GetCellValue(i, "aply_check") == "1" && sheetObj.GetCellValue(i, "cust_itm_cd") != ""){
						retArray += "^^";
						retArray += sheetObj.GetCellValue(i, "cust_itm_id"); //1
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_nm"); //2
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_ut_cd"); //3
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_inr_qty"); //4
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "loc_cd"); //5
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "ttl_ctn_qty"); //6
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "ttl_ea_qty"); //7
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "ttl_qty"); //8
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_wgt"); //9
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_wgt_lbs"); //10
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "act_itm_wgt"); //11
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_vol"); //12
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_vol_cft"); //13
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_len"); //14
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_wdt"); //15
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "itm_hgt"); //16
						retArray += "@@";
						retArray += sheetObj.GetCellValue(i, "item_sys_no"); //17
				   }
			   }
...
function loadPage() {
	...
	formObj.wh_cd.value =arg[0];
	formObj.cust_cd.value =arg[1];
	formObj.ofc_cd.value =arg[2];
	formObj.s_ctrt_no.value =arg[3];
...
function initSheet(sheetObj,sheetNo) {
    switch(sheetNo) {
		case 1:      //IBSheet1 init
			...
			var HeadTitle1 = "chk|Item|Item|Item|Unit|Item|Location|Inventory|Inventory|Inventory|Inventory|Inventory|Inventory|Inventory|" ;
			var HeadTitle2 = "chk|Code|Name|Name|Unit|    |Location|Qty.|EA|Total Qty|KG|LB|CBM|CFT|" ;			
			var headers = [ { Text:HeadTitle1, Align:"Center"},
			                { Text:HeadTitle2, Align:"Center"} ];
			InitHeaders(headers, info);

			var cols = [   
			            {Type:"CheckBox", Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"aply_check",    		  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
			            ...
			            {Type:"Text",      Hidden:1,  Width:150,     Align:"Center",  ColMerge:0,   SaveName:"itm_cd",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0},
			            ...
			            {Type:"Text",      Hidden:0,  Width:70,      Align:"Center",    ColMerge:0,   SaveName:"itm_ut_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Text",      Hidden:1,  Width:150,     Align:"left",    ColMerge:0,   SaveName:"itm_inr_qty",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Text",      Hidden:0,  Width:150,     Align:"Center",  ColMerge:0,   SaveName:"loc_cd",            KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:0,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"ttl_ctn_qty",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"ttl_ea_qty",        KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:0,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"ttl_qty",           KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:0,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"ttl_wgt_kgs",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:0,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"ttl_wgt_lbs",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:0,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"ttl_vol_cbm",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:5,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:0,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"ttl_vol_cft",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:5,   UpdateEdit:0,   InsertEdit:0 },
			            
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"itm_wgt",       	  KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"itm_wgt_lbs",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"act_itm_wgt",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"itm_vol",		      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:5,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"itm_vol_cft",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:5,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"itm_len",           KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"itm_wdt",           KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Float",     Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"itm_hgt",           KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			            {Type:"Text",      Hidden:1,  Width:120,     Align:"Right",   ColMerge:0,   SaveName:"item_sys_no",       KeyField:0,   CalcLogic:"",   Format:"",       PointCount:0,   UpdateEdit:0,   InsertEdit:0 }
			            ];
			...
			SetConfig( { SearchMode:2, MergeSheet:5, Page:20, DataRowMerge:1, TabStop:0 } );
            var info    = { Sort:1, ColMove:1, HeaderCheck:1, ColResize:1 };
            var headers = [ { Text:getLabel('CMM_POP_0400_HDR1_1'), Align:"Center"},
		                    { Text:getLabel('CMM_POP_0400_HDR1_2'), Align:"Center"} ];
            InitHeaders(headers, info);
            ...
            var cols = [ {Type:"CheckBox", Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"aply_check",    		KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
			             ...
			             {Type:"Float",    Hidden:0,  Width:90,   Align:"Right",   ColMerge:0,   SaveName:"rmn_pck_qty",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             ...
			             {Type:"Float",    Hidden:0,  Width:90,   Align:"Right",   ColMerge:0,   SaveName:"rmn_ea_cnt",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             ...
			             {Type:"Float",    Hidden:0,  Width:90,   Align:"Right",   ColMerge:0,   SaveName:"rmn_ttl_qty",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
