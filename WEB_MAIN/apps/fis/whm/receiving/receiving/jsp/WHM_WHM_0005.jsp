...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/whm/receiving/receiving/script/WHM_WHM_0005.js?ver=<%=CLT_JS_VER%>"></script>
		...
		<div class="opus_design_inquiry">
            <table>
                ...
                <tr>
                    ...
                    <td><!-- 
				    --><input type="text" name="cust_cd" id="cust_cd" value="" class="search" maxlength="20" readOnly onKeyDown="codeNameAction('CUSTUMER',this, 'onKeyDown');GetRegisterOfficeCd('CUSTOMER')" 
                   ...
                   <td><!-- 
				    --><input type="text" name="splr_rcvr_cd" id="splr_rcvr_cd" 
				    	 onKeyDown="codeNameAction('SUPPLIER',this, 'onKeyDown');GetRegisterOfficeCd('SUPPLIER')" 
           				...
           				dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:100px" maxlength="20" ><!-- 
