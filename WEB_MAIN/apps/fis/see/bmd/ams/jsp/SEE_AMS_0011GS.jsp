				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							...
							<TD><![CDATA[<bean:write name="row" property="msg_seq"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="msg_type"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="sts"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="disp_cd"/>]]></TD>
                            <TD><![CDATA[<bean:write name="row" property="rslt_msg"/>]]></TD>
                            <TD></TD>
							<TD><![CDATA[<bean:write name="row" property="rcv_tms"/>]]></TD>
                            <TD></TD>
			            </tr>
					</logic:iterate>
					</DATA>
