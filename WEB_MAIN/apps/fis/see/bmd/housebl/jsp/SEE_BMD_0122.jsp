		...
		<div class="layout_vertical_2 sm" style="width:550px;height:500px">
			...
			<table>
	    		...
	    		<tr>
					...
					<td><input type="text" maxlength="30" name="s_shp_phn" value="<bean:write name="hblVO" property="shp_phn"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:207px;text-transform:uppercase;"></td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
					...
					<td><!-- 
						 --><input type="text" maxlength="9"  name="s_shp_zip" id = "s_shp_zip" value="<bean:write name="hblVO" property="shp_zip"/>"  onblur="strToUpper(this);validateValue(this)" onkeyPress="onlyNumberCheck('');"  dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"><!--
	    	...
	    	<table>
	    		...
	    		<tr>
	    			<th><bean:message key="Phone"/></th>
					<td><input type="text" maxlength="30"  name="s_ult_cnee_phn" value="<bean:write name="hblVO" property="ult_cnee_phn"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:203px;text-transform:uppercase;"></td>
	    		</tr>
	    		<tr>
	    			<th><bean:message key="Address"/></th>
		...
		<div class="layout_vertical_2 sm mar_left_8" style="height:500px; width:calc(100% - 560px)">
		    <div class="opus_design_inquiry">
		    	...
		    	<table>
					...
					<tr>
						<th><bean:message key="Phone"/></th>
						<td><input type="text" maxlength="30"  name="s_fwd_phn" value="<bean:write name="hblVO" property="fwd_phn"/>"  onblur="strToUpper(this)"    dataformat="excepthan" style="ime-mode:disabled;width:203px;text-transform:uppercase;"></td>
					</tr>
					...
					<tr>
						<th><bean:message key="Phone"/></th>
						<td><input type="text" maxlength="30"  name="s_inter_cnee_phn" value="<bean:write name="hblVO" property="inter_cnee_phn"/>"  onblur="strToUpper(this)"  dataformat="excepthan" style="ime-mode:disabled;width:203px;text-transform:uppercase;"></td>
					</tr>
					<tr>
						<th><bean:message key="Address"/></th>
					...
					<tr>
						<th><bean:message key="Zip_Code_Country"/></th>
						<td nowrap><!-- 
							 --><input type="text" maxlength="9"  name="s_inter_cnee_zip" id="s_inter_cnee_zip" value="<bean:write name="hblVO" property="inter_cnee_zip"/>"  onblur="strToUpper(this);validateValue(this)"   dataformat="excepthan" style="ime-mode:disabled;width:100px;text-transform:uppercase;"><!--
