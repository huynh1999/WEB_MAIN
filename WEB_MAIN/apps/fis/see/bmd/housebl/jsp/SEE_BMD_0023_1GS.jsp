        ...
        <SHEET>
            ...
            <logic:iterate id="row" name="rowSet">
                <TR>
					...
					<TD><![CDATA[<bean:write name="row" property="item_cntr_list_seq"/>]]></TD>
					...
					<TD><![CDATA[<bean:write name="row" property="item_dg_cd_tp"/>]]></TD>
                    <TD><![CDATA[<bean:write name="row" property="item_dg_cd"/>]]></TD>
                    <TD><![CDATA[<bean:write name="row" property="item_dg_cntc_nm"/>]]></TD>
                    ...
                    <TD><![CDATA[<bean:write name="row" property="item_cntr_no"/>]]></TD>
                </TR>
            </logic:iterate>
                </DATA>
        </SHEET>
