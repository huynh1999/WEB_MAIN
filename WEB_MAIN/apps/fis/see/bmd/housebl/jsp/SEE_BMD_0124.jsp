...
<% 
	String svrUrl = "http://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath();
	String wlNologinUrl = svrUrl + "/NoLogin.html";
	String wlNosedUrl	= svrUrl + "/NoEei.html";
	String wlSuccessUrl = svrUrl + "/Success.html";
%>


<form name="frm3" action="https://ace.cbp.dhs.gov/nace/aes/aesdirect-ui/secured/createWeblinkFiling" method="POST" target="blank">
...
<div id="aes_data_1">
	...
	<input type="hidden" name="wl_nologin_url"  id="wl_nologin_url" 	value="<%=wlNologinUrl%>">
	<input type="hidden" name="wl_nosed_url" 	id="wl_nosed_url" 		value="<%=wlNosedUrl%>">
	<input type="hidden" name="wl_success_url"	id="wl_success_url"  	value="<%=wlSuccessUrl%>">
...
<div id="aes_data_2">
	...
	<input type="hidden" name="BN"		id="BN"		value="<bean:write name="hblVO" property="lnr_bkg_no"/>">
	...
	<input type="hidden" name="POU" 	id="POU" 	value="<bean:write name="hblVO" property="pod_cd"/>">
	<input type="hidden" name="EDA"		id="EDA" 	value="<wrt:write name="hblVO" property="etd_dt_tm" formatType="DATE" fromFormat="yyyyMMdd" format="yyMMdd"/>">
	...
	<input type="hidden" name="VN" 		id="VN" 	value="<bean:write name="hblVO" property="trnk_vsl_nm"/>">
...
<div id="aes_data_3">
	...
	<input type="hidden" name="AD0_10" id="AD0_10" value="">
...
<div id="aes_data_4">
	...
	<input type="hidden" name="AD1_7" id="AD1_7" value="">
...
<!-- 	
https://aesdirect.census.gov/support/weblink_api.html
	D=Direct Consumer
 	G=Government Entity
	O=Other/Unknown
	R=Reseller
...
<div id="aes_data_5">
	...
	<input type="hidden" name="AD4_7" id="AD4_7" value="">
...
<div id="aes_data_6">
	...
	<input type="hidden" name="AD3_7" id="AD3_7" value="">
	...
	<input type="hidden" name="AD3_12" id="AD3_12" value="<bean:write name="hblVO" property="fwd_cnt"/>">
...
<div id="aes_data_temp_<%= i %>">
   	<input type="hidden" name="isLine<%= i %>" id="isLine<%= i %>" value="Y"></input>
	<input type="hidden" name="IT<%= i %>_1" id="IT<%= i %>_1" value="<bean:write name="hblVO" property="exp_cd"/>"></input>
	<input type="hidden" name="IT<%= i %>_2" id="IT<%= i %>_2" value=""></input>
	<input type="hidden" name="IT<%= i %>_3" id="IT<%= i %>_3" value=""></input>
	<input type="hidden" name="IT<%= i %>_4" id="IT<%= i %>_4" value=""></input>
	<input type="hidden" name="IT<%= i %>_5" id="IT<%= i %>_5" value=""></input>
	<input type="hidden" name="IT<%= i %>_6" id="IT<%= i %>_6" value=""></input>
	<input type="hidden" name="IT<%= i %>_7" id="IT<%= i %>_7" value=""></input>
	<input type="hidden" name="IT<%= i %>_8" id="IT<%= i %>_8" value="<bean:write name="hblVO" property="licen_tp"/>"></input>
	<input type="hidden" name="IT<%= i %>_9" id="IT<%= i %>_9" value="<bean:write name="hblVO" property="licen_no"/>"></input>
	<input type="hidden" name="IT<%= i %>_10" id="IT<%= i %>_10" value=""></input>
	<input type="hidden" name="IT<%= i %>_12" id="IT<%= i %>_12" value=""></input>
	<input type="hidden" name="IT<%= i %>_13" id="IT<%= i %>_13" value=""></input>
	<input type="hidden" name="IT<%= i %>_15" id="IT<%= i %>_15" value=""></input>
	<input type="hidden" name="IT<%= i %>_16" id="IT<%= i %>_16" value=""></input>
	<input type="hidden" name="IT<%= i %>_17" id="IT<%= i %>_17" value=""></input>
	<input type="hidden" name="IT<%= i %>_18" id="IT<%= i %>_18" value=""></input>
	<input type="hidden" name="IT<%= i %>_19" id="IT<%= i %>_19" value=""></input>
	<input type="hidden" name="IT<%= i %>_20" id="IT<%= i %>_20" value=""></input>
	<input type="hidden" name="IT<%= i %>_21" id="IT<%= i %>_21" value=""></input>
	
	<input type="hidden" name="EP<%= i %>_1" id="EP<%= i %>_1" value=""></input>
	<input type="hidden" name="EP<%= i %>_2" id="EP<%= i %>_2" value=""></input>
	<input type="hidden" name="EP<%= i %>_3" id="EP<%= i %>_3" value=""></input>
	<input type="hidden" name="EP<%= i %>_4" id="EP<%= i %>_4" value=""></input>
	<input type="hidden" name="EP<%= i %>_5" id="EP<%= i %>_5" value=""></input>
	
	<input type="hidden" name="ODTC<%= i %>_1"	id="ODTC<%= i %>_1" value="<bean:write name="hblVO" property="ddtc_itar_no"/>"></input>
	<input type="hidden" name="ODTC<%= i %>_2"	id="ODTC<%= i %>_2" value="<bean:write name="hblVO" property="ddtc_regi_no"/>"></input>
	<input type="hidden" name="ODTC<%= i %>_3"	id="ODTC<%= i %>_3" value="<bean:write name="hblVO" property="ddtc_eq_flg"/>"></input>
	<input type="hidden" name="ODTC<%= i %>_4"	id="ODTC<%= i %>_4" value="<bean:write name="hblVO" property="ddtc_prty_certi_flg"/>"></input>
	<input type="hidden" name="ODTC<%= i %>_5"	id="ODTC<%= i %>_5" value="<bean:write name="hblVO" property="ddtc_usml_cd"/>"></input>
	<input type="hidden" name="ODTC<%= i %>_6"	id="ODTC<%= i %>_6" value="<bean:write name="hblVO" property="ddtc_pck_qty"/>"></input>
	<input type="hidden" name="ODTC<%= i %>_7"	id="ODTC<%= i %>_7" value="<bean:write name="hblVO" property="ddtc_pck_ut_cd"/>"></input>
</div>
<%
		}
	}
