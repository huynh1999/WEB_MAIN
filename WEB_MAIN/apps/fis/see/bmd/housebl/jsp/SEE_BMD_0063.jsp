...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/fis/see/bmd/housebl/script/SEE_BMD_0063.js?ver=<%=CLT_JS_VER%>"></script>
			...
			<table>
					...
					<tbody>
						<tr>
                            ...
                            <td><input name="hbl_no" type="text" value='<bean:write name="hmOutParam" property="hbl_no"/>' maxlength="50" style="width:100px;" class="search_form-disable" readOnly></td>
                        </tr>
                        <tr>
                     ...
                     <tr>
                               ...
                               <td>
									<input type="text" name="trdp_cd" value='<bean:write name="hmOutParam" property="trdp_cd"/>' class="search_form" style="width:60px;"  onKeyDown="codeNameAction2('trdpcode_dest',this, 'onKeyDown')" onBlur="codeNameAction2('trdpcode_dest',this, 'onBlur')"><!-- 
		                     		...
		                     		--><input type="text" name="trdp_nm" value='<bean:write name="hmOutParam" property="trdp_nm"/>' class="search_form" style="width:234px;" onKeypress="if(event.keyCode==13){doWork('TO_POPLIST', this)}">
                               </td>
                           </tr>
                            <tr>
                           ...
                           <tr>
                               ...
                               <td>
									<input type="text" name="delivery_trdp_cd" value='<bean:write name="hmOutParam" property="delivery_trdp_cd"/>' class="search_form" style="width:60px;"  onKeyDown="codeNameAction2('trdpcode_delivery',this, 'onKeyDown')" onBlur="codeNameAction2('trdpcode_delivery',this, 'onBlur')"><!-- 
		                     		--><button type="button" class="input_seach_btn" tabindex="-1" onClick="doWork('DELIVERY_TO_POPLIST', this)"></button><!-- 
		                     		--><input type="text" name="delivery_trdp_nm" value='<bean:write name="hmOutParam" property="delivery_trdp_nm"/>' class="search_form"  style="width:234px;" onKeypress="if(event.keyCode==13){doWork('DELIVERY_TO_POPLIST', this)}">
                               </td>
                           </tr>
                            <tr>
                               <th><bean:message key="Address"/></th>
                           ...
                           <tr>
                               ...
                               <td>
									<input type="text" name="delivery_on" value='<bean:write name="hmOutParam" property="delivery_on"/>' class="search_form" style="width:60px;">
                               </td>
                           </tr>
                           <tr>
                               <th><bean:message key="Signed_by"/><!--M1234--></th>
                               <td>
									<input type="text" name="singed_by" value='<bean:write name="hmOutParam" property="singed_by"/>' class="search_form" style="width:60px;">
                               </td>
                           </tr>
                           <tr>
