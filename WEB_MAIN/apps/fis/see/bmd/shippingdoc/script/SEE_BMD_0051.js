...
function checkAddModiVal(formObj){
    ...
    */
    ...
    var fileValue = formObj.palt_doc_img_url.value.split("\\");
	var fileName = fileValue[fileValue.length-1]; // 파일명
	
	//OFVFOUR-7742 [FULLTRANS] download attached doc in OIH BL entry issue
	//OFVFOUR-8285 [South East World Wide and Great Luck] Can't Save File - filename with space
	var speChr = fileName.replace(/[A-Za-z0-9`!@#$%^&(){}\[\].'\-_=+ ]/g, "");
	if ( speChr.length != 0 ){
		alert(getLabel('SEA_COM_ALT045'));
		return false;
	}
