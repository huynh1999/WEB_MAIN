        ...
        <SHEET>
            ...
            <logic:iterate id="row" name="rowSet">
                <TR>
                    ...
                    <TD><![CDATA[<bean:write name="row" property="cfs_in_dt"/>]]></TD>
                    <TD><![CDATA[<bean:write name="row" property="devan_dt"/>]]></TD>
                    <TD><![CDATA[<bean:write name="row" property="lfd"/>]]></TD>
                    <TD><![CDATA[<bean:write name="row" property="cntr_go_date"/>]]></TD>
					<TD><![CDATA[<bean:write name="row" property="cntr_rmk" filter="false"/>]]></TD>
					...
					<TD><![CDATA[<bean:write name="row" property="org_pkup_dt"/>]]></TD>
					<TD><![CDATA[<bean:write name="row" property="fnl_dest_eta_dt"/>]]></TD>
					<TD><![CDATA[<bean:write name="row" property="apnt_dt"/>]]></TD>
					<TD><![CDATA[<bean:write name="row" property="de_dt"/>]]></TD>
					<TD><![CDATA[<bean:write name="row" property="free_det_dt"/>]]></TD>
					<TD><![CDATA[<bean:write name="row" property="emty_rt_dt"/>]]></TD>
					<!-- OFVFOUR-7949 [SENKO USA] Show CCN# for Multiple Containers on AN -->
					<TD><![CDATA[<bean:write name="row" property="cntr_ccn_no"/>]]></TD>
                </TR>
            </logic:iterate>
                </DATA>
        </SHEET>
