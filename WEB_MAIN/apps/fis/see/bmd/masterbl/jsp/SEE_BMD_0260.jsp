...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/see/bmd/masterbl/script/SEE_BMD_0260.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="frm1">
    ...
    <input type="hidden" name="chk_intg_bl_seq"  />
    <input type="hidden" name="main_intg_bl_seq"  />
    <input type="hidden" name="combine_no"  />
    <input type="hidden" name="f_opr_usrid"  />
	...
	<input type="hidden" name="pageurl" id="pageurl" value="SEE_BMD_0260.clt"/>
	...
	<div class="wrap_search">
		<div class="opus_design_inquiry" style="width: 1600px">
			<table>
				<colgroup>
					<col width="95">
					<col width="120">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="f_bl_no" id="f_bl_no" maxlength="40" style="ime-mode:disabled; text-transform:uppercase;width:100px;" onkeydown="entSearch();"/></td>
						<th><bean:message key="BL_Type"/></th>
						<td><select name="f_biz_clss_cd" id="f_biz_clss_cd" style="width:100px">
								<option value=''>ALL</option>
								<option value='M'><bean:message key="Master"/></option>
								<option value='H'><bean:message key="House"/></option>
							</select>
						</td>
						<th><bean:message key="Post_Date"/></th>
						<td><input type="text" name="f_post_strdt" id="f_post_strdt" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, this, frm1.f_bkg_enddt);firCalFlag=false;" size='10' maxlength="10" style="width:77px;"><!--
						--><span class="dash">~</span><input type="text" name="f_post_enddt" id="f_post_enddt" onKeyUp="mkDateFormatType(this,event,false,1);if(event.keyCode==13){firCalFlag=true;};" onBlur="chkCmprPrd(firCalFlag, false, this, frm1.f_bkg_strdt, this);firCalFlag=false;" size='10' maxlength="10"  style="width:77px;"><!--
						--><button type="button" id="post_dt_cal" name="post_dt_cal" onclick="doDisplay('DATE11', frm1);" class="calendar" tabindex="-1"></button></td>
