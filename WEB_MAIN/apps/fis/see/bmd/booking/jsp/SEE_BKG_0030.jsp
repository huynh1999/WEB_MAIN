...
<%@page import="com.clt.syscommon.response.CommonEventResponse"%>
	...
	<script type="text/javascript" src="./apps/fis/see/bmd/booking/script/SEE_BKG_0030.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="frm1">
    ...
    <input type="hidden" name="cntrSeq"  />
...
<div class="over_wrap" height="100%">
	<div class="wrap_search">
		<div class="opus_design_inquiry entry_pannel" style="width: 1400px">
			<table>
				...
				<tbody>
                    <tr>
                    	<th><input type="radio" name="f_biz_clss_cd" id="f_carrier_bkg" value="M" checked> <bean:message key="Carrier_Booking"/></td>
					    <th><input type="radio" name="f_biz_clss_cd" id="f_customer_bkg" value="H"> <bean:message key="Customer_Booking"/></td>
                        <th><bean:message key="Booking_No"/></th>
						<td><input type="text" name="f_bkg_no" id="f_bkg_no" required="required" dataformat="excepthan" style="ime-mode:disabled; width:115px;text-transform:uppercase;" onblur="strToUpper(this);" onkeydown="entSearch();"><!--
						--><button type="button"  id="btn_Booking_No" name="btn_Booking_No" class="input_seach_btn" tabindex="-1" onClick="javascript:openBkgPopUp();"></button>
						</td>
					</tr>
				</tbody>
			</table>
	...
	<div class="wrap_result">
	   <h3 class="title_design"><bean:message key="Container"/></h3>
	...
	<div class="wrap_result">
		    ...
		    <tbody >
	            <tr height="50">
                    ...
                    <td>
                    	...
                    	<button type="button" class="btn_etc" onClick="javascript:splitBkg();"><bean:message key="Split"/></button>
                    </td>
	            </tr>
	            <tr valign="top">
	                <td></td>
        ...
        <h3 class="title_design"><bean:message key="Booking"/></h3>
            <div class="opus_design_grid">       
