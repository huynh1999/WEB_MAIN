...
<%@ taglib uri="clt-paging"   prefix="paging" %>
    ...
    <script language="javascript" src="<%=CLT_PATH%>/apps/fis/see/frt/freight/script/SEE_FRT_0010.js?ver=<%=CLT_JS_VER%>"></script>
...
<body class="td" onLoad="javascript:loadPage();doWork('SEARCHLIST01');doHideProcess();">
<form name="frm1" method="POST" action="./">
                        ...
                        <td width="770" valign="top">
                            <table width="770" border="0" cellspacing="1" cellpadding="0" class="table">
								<tr>
                                    ...
                                    <td class="grid_head"><bean:message key="Booking_No"/></td>
                                    <td class="table_body_l">
                                ...
                                <tr>
                                    <td class="grid_head"><bean:message key="Carrier"/></td>
                                    <td class="table_body_c">
                                    ...
                                    <td class="grid_head"><bean:message key="OB_DT"/></td>
    ...
    <table width="950" border="0" cellspacing="0" cellpadding="0">
        ...
        <div id="tabLayer" style="display:inline;margin-top:0px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td valign="top">
