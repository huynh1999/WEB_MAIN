				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="fre_day_seq"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cntr_tpsz_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="scac_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="port_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="tmnl_fre_day"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="pdm_fre_day"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="comb_fre_day"/>]]></TD>
