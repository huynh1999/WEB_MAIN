...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/sal/tfm/tariff/script/SAL_TFM_0050.js?ver=<%=CLT_JS_VER%>"></script>
...
<script language="javascript">
    ...
    <!-- Rate Class Code 코드조회-->
	<bean:define id="param6List"  name="rtnMap" property="PARAM6"/>
	<logic:iterate id="codeVO" name="param6List">
		...
		PARAM6_1+= '<bean:write name="codeVO" property="cd_nm"  filter="false"/>';
        PARAM6_2+= '<bean:write name="codeVO" property="cd_val" filter="false"/>';
    </logic:iterate>
                        ...
                        <tr>
		                    ...
		                    Buy                    
	                      	...
	                      	<td><img src="<%=CLT_PATH%>/web/img/main/blank.gif" width="10"></td>
	                      	 -->
                            <td width="30" nowrap="nowrap" class="table_search_head"><bean:message key="Departure"/></td>
                            ...
                            <td><img src="<%=CLT_PATH%>/web/img/main/blank.gif" width="10"></td>
                            <td width="30" nowrap="nowrap" class="table_search_head"><bean:message key="Destination"/></td>
                            <td nowrap="nowrap" class="table_search_body">
            ...
            <td align="left" class="table_search_bg">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" height="20">
                  <tr>
					...
					<td align="right" onclick="doWork('MODIFY1')" width="50" id="rowAdd2" style="display:none">
						<table height="21" border="0" cellpadding="0" cellspacing="0" style="cursor:hand" >
							<tr>
								<td width="11"><img src="<%=CLT_PATH%>/web/img/main/bt_left.gif" width="11" height="21"></td>
								<td background="<%=CLT_PATH%>/web/img/main/bt_bg.gif" class="bt_name"><bean:message key="Save"/></td>
                  ...
                  <tr>
                    <td nowrap="nowrap" width="120">
                    	<table border="0" cellpadding="0" cellspacing="0">
                    		<tr>
                    			<td nowrap="nowrap"  class="sub_title"  width="120">
                    				<img src="<%=CLT_PATH%>/web/img/main/sub_title_arrow.gif" width="7" height="7" hspace="1"><bean:message key="Others"/>
                    			</td>
                    		</tr>
                    	</table>
                    </td>
                    <td class="sub_title2"><img src="<%=CLT_PATH%>/web/img/main/blank.gif"></td>
                    <td align="right" onclick="doWork('ROWADD3')" width="50" id="rowAdd3" style="display:none">
						<table height="21" border="0" cellpadding="0" cellspacing="0" style="cursor:hand">
							<tr>
								<td width="11"><img src="<%=CLT_PATH%>/web/img/main/bt_left.gif" width="11" height="21"></td>
								<td background="<%=CLT_PATH%>/web/img/main/bt_bg.gif" class="bt_name"><bean:message key="Add"/></td>
					...
					<td align="right" onclick="doWork('MODIFY2')" width="50" id="rowAdd4" style="display:none">
						<table height="21" border="0" cellpadding="0" cellspacing="0" style="cursor:hand" >
							<tr>
								<td width="11"><img src="<%=CLT_PATH%>/web/img/main/bt_left.gif" width="11" height="21"></td>
								<td background="<%=CLT_PATH%>/web/img/main/bt_bg.gif" class="bt_name"><bean:message key="Save"/></td>
