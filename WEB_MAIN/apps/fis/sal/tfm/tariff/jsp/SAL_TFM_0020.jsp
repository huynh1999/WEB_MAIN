...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/sal/tfm/tariff/script/SAL_TFM_0020.js?ver=<%=CLT_JS_VER%>"></script>
                ...
                <td width="120" align="left" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td nowrap="nowrap" class="table_search_body">
                            	<input name="trdp_cd" value='<%=JSPUtil.getParameter(request, "trdp_cd", "") %>' type="text" maxlength="20" class="search_form" onKeyDown="codeNameAction('trdpCode',this, 'onKeyDown')" onBlur="codeNameAction('trdpCode',this, 'onBlur');javascript:this.value=this.value.toUpperCase();" dataformat="excepthan" style="ime-mode:disabled;text-transform:uppercase;width:100;">
                            ...
                            <td nowrap="nowrap" class="table_search_body">
                            	<input name="trf_term_dt" type="text" value='' onKeyUp="mkDateFormatType(this, event, false, 1)" onBlur="mkDateFormatType(this, event, true, 1)" class="search_form" style="width:72px;" maxlength="10"/>
