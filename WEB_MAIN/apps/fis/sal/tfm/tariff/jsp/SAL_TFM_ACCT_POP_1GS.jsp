<%--
=========================================================
*@FileName   : SAL_TFM_ACCT_POP_1GS.jsp
*@FileTitle  : Rate Sea Management Named Account Pop-up
*@Description: Rate Sae Management Named Account Pop-up
*@author     :
				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<TR>
							...
							<TD><![CDATA[<bean:write name="row" property="nm_acct_seq"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="nm_acct_tp"/>]]></TD>
