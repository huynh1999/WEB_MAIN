...
=========================================================
*@FileName   : ClosingOtherMgmtGS.jsp
*@FileTitle  : 
*@Description: 
*@author     : 
	...
	<logic:notEmpty name="EventResponse" property="mapVal">
		...
		<SHEET>
			<ETC-DATA> 
			    ...
			    <ETC KEY="retType"><bean:write name="rowSet" property="retType"/></ETC>
			</ETC-DATA> 
		</SHEET>
		...
		<logic:notEmpty name="rowSet" property="header">
			...
			<FIELD>
				<DATA TOTAL="1">
						<listCnt><![CDATA[<bean:write name="rowSet" property="listCnt"/>]]></listCnt>
						<cls_no><![CDATA[<bean:write name="rowSetField" property="cls_no"/>]]></cls_no>
						<ctrt_no><![CDATA[<bean:write name="rowSetField" property="ctrt_no"/>]]></ctrt_no>
						<ctrt_nm><![CDATA[<bean:write name="rowSetField" property="ctrt_nm" filter="false"/>]]></ctrt_nm>
						<cust_nm><![CDATA[<bean:write name="rowSetField" property="cust_nm" filter="false"/>]]></cust_nm>
						<cust_cd><![CDATA[<bean:write name="rowSetField" property="cust_cd"/>]]></cust_cd>
						<sell_buy_tp_cd><![CDATA[<bean:write name="rowSetField" property="sell_buy_tp_cd"/>]]></sell_buy_tp_cd>
						<inv_ttl_amt><![CDATA[<bean:write name="rowSetField" property="inv_ttl_amt"/>]]></inv_ttl_amt>
						<curr_cd><![CDATA[<bean:write name="rowSetField" property="curr_cd"/>]]></curr_cd>
						<sts_cd><![CDATA[<bean:write name="rowSetField" property="sts_cd"/>]]></sts_cd>
						<sts_nm><![CDATA[<bean:write name="rowSetField" property="sts_nm"/>]]></sts_nm>
						<cls_dt><![CDATA[<bean:write name="rowSetField" property="cls_dt"/>]]></cls_dt>
						<%-- filter="false" 처리가 되어있지 않을 경우 & 가 amp;로 변환되어 저장시마다 자가증식하는 버그 수정 --%> 
						<ref_no><![CDATA[<bean:write name="rowSetField" property="ref_no" filter="false"/>]]></ref_no>
						<wh_cd><![CDATA[<bean:write name="rowSetField" property="wh_cd"/>]]></wh_cd>
						<f_remark><![CDATA[<bean:write name="rowSetField" property="f_remark" filter="false"/>]]></f_remark>
						<wm_doc_seq><![CDATA[<bean:write name="rowSetField" property="wm_doc_seq"/>]]></wm_doc_seq>
						<ofc_cd><![CDATA[<bean:write name="rowSetField" property="ofc_cd"/>]]></ofc_cd>
				</DATA>
			</FIELD>
		</logic:notEmpty>
