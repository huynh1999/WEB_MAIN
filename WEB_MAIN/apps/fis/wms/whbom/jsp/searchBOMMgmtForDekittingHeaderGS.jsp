			...
			<SHEET>
				...
				<logic:iterate id="row" name="rowSet">
					<tr>
						...
						<TD><![CDATA[<bean:write name="row" property="dekit_item_ea_qty"/>]]></TD>
						...
						<TD><![CDATA[<bean:write name="row" property="dekit_item_cbm"/>]]></TD>
						<TD><![CDATA[<bean:write name="row" property="dekit_item_cbf"/>]]></TD>
						<TD><![CDATA[<bean:write name="row" property="dekit_item_grs_kgs"/>]]></TD>
						<TD><![CDATA[<bean:write name="row" property="dekit_item_grs_lbs"/>]]></TD>
						<TD><![CDATA[<bean:write name="row" property="dekit_item_net_kgs"/>]]></TD>
						<TD><![CDATA[<bean:write name="row" property="dekit_item_net_lbs"/>]]></TD>
						...
						<TD><![CDATA[<bean:write name="row" property="clickflag"/>]]></TD>
