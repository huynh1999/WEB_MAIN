				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="load_item_ea_qty"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="load_item_cbm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="load_item_cbf"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="load_item_grs_kgs"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="load_item_grs_lbs"/>]]></TD>
							
							<TD><![CDATA[<bean:write name="row" property="load_item_net_kgs"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="load_item_net_lbs"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="lp_no"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="load_item_ea_qty_org"/>]]></TD>
			            </tr>
					</logic:iterate>
					</DATA>
				</SHEET>
