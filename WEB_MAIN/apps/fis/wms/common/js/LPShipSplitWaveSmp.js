	...
	switch(sheetNo) {
		case 1:      //IBSheet1 init
			with(sheetObj){
			    ...
			    var cols = [ 
			             {Type:"CheckBox",  Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:prefix+"del",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
...
function btn_OK(){
	...
	var saveXml = sheet1.GetSaveData("addLPSplitShipWaveSimpleGS.clt", sParam);
