						...
						{data:[
						      <logic:iterate id="row" name="rowSet" >
						       <%cnt++;%>
						       {
						        ...
						        ,item_cbf : "<bean:write name="row" property="item_cbf"/>"
						        ,item_grs_kgs : "<bean:write name="row" property="item_grs_kgs"/>"
						        ,item_grs_lbs : "<bean:write name="row" property="item_grs_lbs"/>"
						        ,item_net_kgs : "<bean:write name="row" property="item_net_kgs"/>"
						        ,item_net_kgs : "<bean:write name="row" property="item_net_lbs"/>"
						        ...
						        ,inbound_dt : "<bean:write name="row" property="inbound_dt"/>"
						        ,exp_dt : "<bean:write name="row" property="exp_dt"/>"
						        ,lot_04 : "<bean:write name="row" property="lot_04"/>"
						        ,lot_05 : "<bean:write name="row" property="lot_05"/>"
						        ,ctrt_no : "<bean:write name="row" property="ctrt_no"/>"
						        ,ctrt_nm : "<bean:write name="row" property="ctrt_nm"/>"
