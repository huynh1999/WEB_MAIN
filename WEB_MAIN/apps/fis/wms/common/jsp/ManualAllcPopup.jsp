...
<%@include file="./../../../../../../syscommon/header/CLTHeader.jsp"%>
    ...
    <script type="text/javascript" src="./apps/fis/wms/common/js/ManualAllcPopup.js?ver=<%=CLT_JS_VER%>"></script>
<%
				...
				<table>
					...
					<tbody>
						<tr>
							...
							--><input name="item_nm" id="item_nm" type="text" style="width:230px;ime-mode:disabled;text-transform:uppercase;" dataformat="excepthan" onBlur="strToUpper(this);" readonly tabindex="-1"/><!-- 
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="5"><input name="wh_loc_nm" id="wh_loc_nm" type="text"  style="width:165px;ime-mode:disabled;text-transform:uppercase;" dataformat="excepthan" onBlur="strToUpper(this);getLocationInfo('c')" OnKeyDown="if(event.keyCode==13){getLocationInfo('e');}" onChange="getLocationInfo('c')"/><!-- 
