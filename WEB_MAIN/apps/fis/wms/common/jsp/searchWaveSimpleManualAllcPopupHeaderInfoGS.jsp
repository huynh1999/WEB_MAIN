				...
				<bean:define id="rowSet" name="EventResponse" property="listVal"/>
					<DATA TOTAL="<bean:write name="EventResponse" property="listValCnt"/>">
						<logic:iterate id="row" name="rowSet">
                            ...
                            <item_cd><bean:write name="row" property="item_cd"/></item_cd>
                            <item_nm><bean:write name="row" property="item_nm"/></item_nm>
                            ...
                            <lic_plat_no><![CDATA[<bean:write name="row" property="lic_plat_no"/>]]></lic_plat_no>
                            <item_ser_no><![CDATA[<bean:write name="row" property="item_ser_no"/>]]></item_ser_no>
                            <po_no><![CDATA[<bean:write name="row" property="po_no"/>]]></po_no>
							<tol_rum><![CDATA[<bean:write name="row" property="tol_rum" />]]></tol_rum>
							<%-- #6027 [LATONA] WMS 개선 문의사항 - Auto Allocation 이후, LP 수량 수정 가능하도록 --%>
							<ovr_aloc_yn><![CDATA[<bean:write name="row" property="ovr_aloc_yn" />]]></ovr_aloc_yn>
						</logic:iterate>
					</DATA>
			</logic:notEmpty>
</logic:empty>
