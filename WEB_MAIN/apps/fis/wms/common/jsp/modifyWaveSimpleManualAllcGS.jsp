				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="stock"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="alloc"/>]]></TD>
							...
							<TD></TD>
							<TD><![CDATA[<bean:write name="row" property="div"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="issu_cnt"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="load_plan_cnt"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="load_item_ea_qty_min_check"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="alloc_org"/>]]></TD>
