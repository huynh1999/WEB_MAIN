				...
				<bean:define id="rowSet" name="EventResponse" property="listVal"/>
					<DATA TOTAL="">
						<logic:iterate id="row" name="rowSet">
							...
							<loading_item_ea_qty><![CDATA[<bean:write name="row" property="loading_item_ea_qty"/>]]></loading_item_ea_qty>
							<loading_item_cbm><![CDATA[<bean:write name="row" property="loading_item_cbm"/>]]></loading_item_cbm>
							<loading_item_grs_kgs><![CDATA[<bean:write name="row" property="loading_item_grs_kgs"/>]]></loading_item_grs_kgs>
							<loading_item_net_kgs><![CDATA[<bean:write name="row" property="loading_item_net_kgs"/>]]></loading_item_net_kgs>	
						</logic:iterate>
					</DATA>
			</logic:notEmpty>
</logic:empty>
