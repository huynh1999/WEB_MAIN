...
*@FileName   : TransloadingOutboundItemPopup.js
*@FileTitle  : TransloadingOutboundItemPopup 
...
<%@include file="./../../../../../../syscommon/header/CLTHeader.jsp"%>
    ...
    <script type="text/javascript" src="./apps/fis/wms/common/js/TransloadingOutboundItemPopup.js?ver=<%=CLT_JS_VER%>"></script>                                                                                                                                                                                                                                         
<%
	String wh_cd = "";
	String ctrt_no = "";
	String tlo_no = "";
...
<input type="hidden" name="tlo_no" 			value="<%=tlo_no%>" />
<input type="hidden" name="tlo_seq" 		value="<%=tlo_seq%>" />
<input type="hidden" name="wib_bk_no" 			value="<%=wib_bk_no%>" />
<input type="hidden" name="wob_bk_no" 			value="<%=wob_bk_no%>" />
<input type="hidden" name="truck_tpsz_cd" 	value="<%=truck_tpsz_cd%>" />
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span><bean:message key="Outbound_Item_List"/></span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
		<div class="opus_design_btn">
			 <button type="button" class="btn_accent" name="btn_save" id="btn_save"><bean:message key="Save"/></button><!-- 
