				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="putaway_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="alloc_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="move_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="replenish_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="adjust_flg"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="loc_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="space_tp_cd"/>]]></TD>
