...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="./apps/fis/pfm/mgt/management/script/PFM_MGT_0090.js?ver=<%=CLT_JS_VER%>"></script>
	<!-- #1438 [PATENT] 0215_24 ACCOUNTING REPORT - MULTI OFFICE SELECTION -->	
	<!-- #5193 - [BINEX] AFTER V470.06 RELEASE, CANNOT GENERATE GL REPORT ON IE  -->
	...
	<input type="hidden" name="f_sel_ofc" id="f_sel_ofc" value=""/>
	...
	<!-- inquiry_area(S) -->	
		<div class="wrap_result">
			<div class="layout_wrap">
				<div style="width:610px;float:left!important" >
			<div class="opus_design_inquiry sm">
					             ...
					             <tr>
			                    	...
			                    	<td align="left">
			                    	 ...
			                    	 <td>
					                   	...
					                   	<bean:define id="oficeList" name="valMap" property="ofcList"/>
					                   	<select name="s_ofc_cd" id = "s_ofc_cd" class="form-control" multiple="multiple" OnChange="doWork('CURR_SEARCH');selOficeDisplay(this);" >
											<logic:iterate id="ofcVO" name="oficeList">
							                    <logic:equal name="ofcVO" property="ofc_cd" value="<%= userInfo.getOfc_cd()%>" >
							                    	<option selected="selected"  value="<bean:write name="ofcVO" property="ofc_cd"/>"><bean:write name="ofcVO" property="ofc_cd"/></option>
							                    </logic:equal>
	                        				...
	                        				<td style="width:331px">
	                        					<table>
	                        						<tr>
									            		...
									            		<td><!-- 
									            			 --><input class="search_form" type="text" name="range_fr" id="range_fr" value="<bean:write name="valMap" property="MIN_GL"/>" onblur="strToUpper(this);" onKeyPress="ComKeyOnlyAlphabet('uppernum')"; dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:100px" maxlength="20"><span class="dash">~</span><!-- 
									            			 --><input class="search_form" type="text" name="range_to" id="range_to" value="<bean:write name="valMap" property="MAX_GL"/>" onblur="strToUpper(this);" onKeyPress="ComKeyOnlyAlphabet('uppernum')"; dataformat="excepthan" style="ime-mode:disabled; text-transform:uppercase;width:100px" maxlength="20">
									            		</td>
	                        						</tr>
	                        						<tr>
			    ...
			    <div class="opus_design_inquiry sm" style="width:450px; height: 405px">
			    	<table>
			    		<colgroup>
				        	<col width="173">
				        	<col width="80">
