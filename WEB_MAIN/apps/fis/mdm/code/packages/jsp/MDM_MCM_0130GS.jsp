				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							...
							<TD><![CDATA[<bean:write name="row" property="ams_pck_cd_val"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="afr_pck_cd_val"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cstms_pck_cd_val"/>]]></TD>
