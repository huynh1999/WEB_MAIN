<%--
=========================================================
*@FileName   : MDM_MCM_0300_NEW_HISGS.jsp
*@FileTitle  : New G/L History
*@Description: New G/L History
			...
			<logic:notEmpty name="EventResponse" property="listVal">
				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							<TD><![CDATA[<bean:write name="row" property="his_seq"  filter="false" />]]></TD>
							<TD><![CDATA[<bean:write name="row" property="modi_seq"  filter="false" />]]></TD>
