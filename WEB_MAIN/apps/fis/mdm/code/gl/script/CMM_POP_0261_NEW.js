...
=========================================================
 *@FileName   : CMM_POP_0261_NEW.js
 *@FileTitle  : GL CODE POP UP
 *@Description: Container 의 조회/등록/수정/삭제의 사용자
 *              요청을 처리하기 위한 업무처리 로직 메소드를 정의함
 *              
 *@author  : Tien,Le Anh
 *@version : 1.0 - 01/08/2018
 *@since   : 01/08/2018 (Tien,Le Anh)
	...
	try {
        switch(srcName) {
    	   case "SEARCHLIST":
                ...
                sheetObj.DoSearch("CMM_POP_0261GS_NEW.clt", FormQueryString(formObj) );
    	   break;    
       	   case "CLOSE":
       		   ComClosePopup(); 
       	   break;	   
         ...
         case 1:      //IBSheet1 init
            with (sheetObj) {
             ...
             var cols = [ {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"ggl_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },	                      
	                      {Type:"Text",      Hidden:0,  Width:200,  Align:"Left",    ColMerge:0,   SaveName:"ggl_nm",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
...
//	var openMean=formObj.openMean.value ; 
	...
	retArray += "|";
	retArray += sheetObj.GetCellValue(Row, "ggl_nm");
	//alert(retArray);
