<%--
=========================================================
*@FileName   : CMM_POP_0080.jsp
*@FileTitle  : CMM
*@Description: container pop
*@author     : 이광훈 - container pop
...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/mdm/code/container/script/CMM_POP_0080.js?ver=<%=CLT_JS_VER%>"></script>
...
<!-------------------- title begin -------------------->
					<tr>
						<td width="270" class="bigtitle"><bean:message key="Container_Type_Size"/></td>
					</tr>
<!-------------------- title end -------------------->
					<!--space -->
			        <tr>
