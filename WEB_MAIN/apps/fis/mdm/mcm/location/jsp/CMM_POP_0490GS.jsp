				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="from_area_nm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="to_area_nm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="div_cd"/>]]></TD>
