<%--
=========================================================
*@FileName   : MDM_MCM_0030GS.jsp
*@FileTitle  : Contry Code
*@Description: 국가 정보 조회
				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							...
							<TD><![CDATA[<bean:write name="row" property="prnt_conti_nm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="conti_nm" filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cnt_locl_nm" filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="cnt_eng_nm" filter="false"/>]]></TD>
							...
							<TD><![CDATA[<bean:write name="row" property="dock_rcpt_rmk"/>]]></TD>
