				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>
							...
							<TD><![CDATA[<bean:write name="row" property="item_dtl_cd_tp"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="item_dtl_cd"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="srt_seq"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="is_v"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="is_l"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="is_p"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="is_s"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="item_dtl_cd_tp_nm"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="ctrt_no"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="item_sys_no"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="item_dtl_cd_seq"/>]]></TD>
			            </tr>
					</logic:iterate>
					</DATA>
				</SHEET>
