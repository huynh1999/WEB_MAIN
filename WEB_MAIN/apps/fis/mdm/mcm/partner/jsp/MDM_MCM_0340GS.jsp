		...
		<%-- 조회 결과가 있는 경우 --%>
			<logic:notEmpty name="EventResponse" property="listVal">
				...
				<logic:notEmpty name="EventResponse" property="mapVal">
					...
					<MESSAGE><![CDATA[<bean:write name="tmpMap" property="RTNMSG"/>]]></MESSAGE>
				</logic:notEmpty>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							<TD></TD>
							<TD><![CDATA[<bean:write name="row" property="oth_tp" filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="rmk"    filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="oth_prfx"  filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="oth_no"  filter="false"/>]]></TD>
