...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/cmm/mem/script/CMM_MEM_0020.js?ver=<%=CLT_JS_VER%>"></script>
	   		...
	   		<input name="palt_trdp_cd" type="hidden" value='<bean:write name="objVO" property="palt_trdp_cd"/>' class="search_form-disable" style="width:80;"/>
	   		 ...
	   		 <table>
                 ...
                 <tr>
                     ...
                     <td><html:text name="objVO" property="palt_doc_no" styleClass="search_form" maxlength="20" style="width:238px;"/></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                     ...
                     <td><textarea name="palt_doc_msg" class="search_form" style="width:560px;height:150px" maxlength="1000"><bean:write name="objVO" property="palt_doc_msg" filter="false"/></textarea></td>
                 </tr>
                 <tr>
                     <th><bean:message key="Remark"/></th>
                     <td><textarea name="palt_doc_rmk" class="search_form" style="width:560px;height:40px" maxlength="100"><bean:write name="objVO" property="palt_doc_rmk" filter="false"/></textarea></td>
                 </tr>
             </table>
	   	</div>
	</div>
