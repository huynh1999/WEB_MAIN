...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script language="javascript" src="./apps/fis/cmm/pop/housebl/script/CMM_POP_0400.js?ver=<%=CLT_JS_VER%>"></script>
...
<form name="form" method="POST" action="./">
	...
	<div class="layer_popup_title">
		...
		<div class="page_title_area clear">
		   	<h2 class="page_title">
				<bean:message key="PO"/> & <bean:message key="Item"/> <bean:message key="Search"/></span>
		   </h2>
		   <!-- btn_div -->
