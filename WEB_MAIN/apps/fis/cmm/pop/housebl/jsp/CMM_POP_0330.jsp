...
<%@ taglib uri="clt-paging"   prefix="paging" %>
	...
	<script type="text/javascript" src="<%=CLT_PATH%>/apps/fis/cmm/pop/housebl/script/CMM_POP_0330.js?ver=<%=CLT_JS_VER%>"></script>
...
<%-- 	<div class="page_title_area clear">
 ...
 --%>
	...
	<div>
		...
		<table id = "tb_hbl_etry_chk" border="0"  cellspacing="0" cellpadding="0">
			<tr align="left">	
				<td width="10px"><img src="<%=CLT_PATH%>/web/img/main/blank.gif"></td>
				<td width="67px" id = "col_shmt_itm_chk" ><input name="shmt_itm_chk" id="shmt_itm_chk" type="checkbox"><label for="shmt_itm_chk"><bean:message key="Shipment_Item"/></label></td>
				<td width="68px" style="display: none" id = "col_mrk_desc_chk" ><input name="mrk_desc_chk" id="mrk_desc_chk" type="checkbox"><label for="mrk_desc_chk"><bean:message key="Mark_Description"/></label></td>
				<td width="60px" style="display: none" id = "col_rmk_chk" ><input name="rmk_chk" id="rmk_chk" type="checkbox"><label for="rmk_chk"><bean:message key="Remark"/></label></td>
			...
			<tr>
				<td colspan="4" height="5"><img src="<%=CLT_PATH%>/web/img/main/blank.gif">
				</td>
			</tr>
		</table>

		<table id = "tb_hbl_refno_chk" style="display: none" border="0"  cellspacing="0" cellpadding="0">
			<tr align="left">	
				<td width="11px"><img src="<%=CLT_PATH%>/web/img/main/blank.gif"></td>
				<td width="73px" id = "col_ref_no_chk" ><input name="ref_no_chk" id="ref_no_chk" type="checkbox"><label for="ref_no_chk"><bean:message key="Filing_No"/></label></td>
				<td width="144px" id = "col_frt_trm_chk" ><input name="frt_trm_chk" id="frt_trm_chk" type="checkbox"><label for="frt_trm_chk"><bean:message key="Freight_Term"/></label></td>
				<td width="*" id = "col_shpr_csne_chk" style="display: none"><input name="shpr_csne_chk" id="shpr_csne_chk" type="checkbox"><label for="shpr_csne_chk"><bean:message key="Shipper_Consignee"/></label></td>
			</tr>
		</table>		
	</div>
