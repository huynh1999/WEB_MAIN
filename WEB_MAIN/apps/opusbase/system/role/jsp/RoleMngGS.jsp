				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						...
						<!-- #1850 [BINEX V4421] ROLE NAME AND DESCRIPTION DOESN'T SAVE "&" AND AFTER -->
							...
							<TD><![CDATA[<bean:write name="row" property="role_nm"/>]]></TD>
							
							<TD><![CDATA[<bean:write name="row" property="srt_seq"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="role_desc"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="tgt_auth_role_cd"/>]]></TD>
