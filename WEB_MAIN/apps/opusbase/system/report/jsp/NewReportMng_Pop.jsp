...
<%@ page pageEncoding="UTF-8"%>
	...
	<%
		String pop_yn = (String)request.getParameter("pop_yn");
	%>
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<h2 class="page_title"><span><bean:message key="Report_Set_Mng"/></span></h2>			
		<div class="opus_design_btn">
		 ...
		 --><button type="button" class="btn_normal" name="btnSelect" id="btnSelect" onClick="doWork('APPLY')"  ><bean:message key="Select"/></button><!-- 
		...
		<div class="opus_design_inquiry ">
			<table>	
				...
				<tr>
					...
					<td><input type="text" id="f_call_id" value="" class="search_form" dataformat="excepthan" onKeyDown="if(event.keyCode == 13){doWork('SEARCHLIST')};" style="ime-mode:disabled;width:100px"/></td>
					<th><bean:message key="Report_ID"/></th>
					<td><input type="text" id="f_rpt_id" value="" class="search_form" dataformat="excepthan" onKeyDown="if(event.keyCode == 13){doWork('SEARCHLIST')};" style="ime-mode:disabled;width:100px"/></td>
