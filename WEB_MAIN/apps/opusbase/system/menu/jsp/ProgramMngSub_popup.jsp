...
%>	
	...
	<script language="javascript" src="<%=CLT_PATH%>/apps/opusbase/system/menu/script/ProgramMngSub_popup.js?ver=<%=CLT_JS_VER%>"></script>
	...
	<bean:parameter id="pgm_seq" name="pgm_seq" value=""/>
...
<form name="frm1" method="POST" action="./">
	...
	<input type="hidden" name="f_pgm_seq" value='<bean:write name="pgm_seq"/>'/>
	...
	<div class="layer_popup_title">
		...
		<div class="page_title_area clear">
		   <h2 class="page_title"><bean:message key="Menu_List"/></h2>
		   <!-- btn_div -->
