				...
				<SHEET>
					...
					<logic:iterate id="row" name="rowSet">
						<tr>	
							...
							<!-- #535: [SBS] 다국어 처리 V1.0 -->
							<TD><![CDATA[<bean:write name="row" property="pgm_nm_en"   filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="pgm_nm_zh"   filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="pgm_nm_ja"   filter="false"/>]]></TD>
							<TD><![CDATA[<bean:write name="row" property="pgm_nm_ko"   filter="false"/>]]></TD>
