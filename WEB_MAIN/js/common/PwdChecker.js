//best -> 14글자 이상, 대 / 소 / 숫자 / 특문(!@#$%&*()_+-='\";:[{]}\|.>,</?`~) 3종류 포함 / 사전에 저장되지 않은 문자중 비슷하지 않은 문자.
//strong -> 8글자 이상, 대 / 소 / 숫자 / 특문(!@#$%&*()_+-='\";:[{]}\|.>,</?`~) 3종류 포함 / 사전에 저장되지 않은 문자중 비슷하지 않은 문자.
//medium -> 8글자 이상, 대 / 소 / 숫자 / 특문(!@#$%&*()_+-='\";:[{]}\|.>,</?`~) 2종류 포함 / 사전에 저장되지 않은 문자.
